...
- Parser token XMLs: `src/main/java/com/dbn/language/**/dialect/*/*_parser_tokens.xml` are partially generated: hand-written sections may be edited, but `MARKER_*` blocks are generated from `modules/dbn-dev` registries/tooling and should not be edited directly.
