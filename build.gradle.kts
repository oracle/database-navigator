...
*/
    ...
    implementation("com.oracle.oci.sdk:oci-java-sdk-artifacts:3.76.1@jar")
    ...
    implementation("org.glassfish.jersey.core:jersey-client:2.48@jar")
    implementation("org.glassfish.jersey.core:jersey-common:2.48@jar")
