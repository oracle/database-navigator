...
![Operations settings page](./img/settings-operations.png)
...
![Transaction Manager settings](./img/settings-operations-transactions.png)
...
![Session Browser settings](./img/settings-operations-sessions.png)
