...
"long"{ws}"raw" {return tt.dtt(17);}
"long"{ws}"varchar" {return tt.dtt(18);}
"long" {return tt.dtt(19);}
"national"{ws}"char"{ws}"varying" {return tt.dtt(20);}
"national"{ws}"char" {return tt.dtt(21);}
"national"{ws}"character"{ws}"varying" {return tt.dtt(22);}
"national"{ws}"character" {return tt.dtt(23);}
"nchar"{ws}"varying" {return tt.dtt(24);}
"nchar" {return tt.dtt(25);}
"nclob" {return tt.dtt(26);}
"number" {return tt.dtt(27);}
"numeric" {return tt.dtt(28);}
"nvarchar2" {return tt.dtt(29);}
"pls_integer" {return tt.dtt(30);}
"raw" {return tt.dtt(31);}
"real" {return tt.dtt(32);}
"rowid" {return tt.dtt(33);}
"smallint" {return tt.dtt(34);}
"string" {return tt.dtt(35);}
"timestamp" {return tt.dtt(36);}
"urowid" {return tt.dtt(37);}
"varchar2" {return tt.dtt(38);}
