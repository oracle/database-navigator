...
"pls_integer" {return tt.dtt(33);}
"raw" {return tt.dtt(34);}
"real" {return tt.dtt(35);}
"rowid" {return tt.dtt(36);}
"smallint" {return tt.dtt(37);}
"string" {return tt.dtt(38);}
"timestamp" {return tt.dtt(39);}
"urowid" {return tt.dtt(40);}
"varchar" {return tt.dtt(41);}
"varchar2" {return tt.dtt(42);}
"vector" {return tt.dtt(43);}
"with"{ws}"local"{ws}"time"{ws}"zone" {return tt.dtt(44);}
"with"{ws}"time"{ws}"zone" {return tt.dtt(45);}
...
"errors" {return tt.ktt(123);}
"error_code" {return tt.ktt(124);}
"error_index" {return tt.ktt(125);}
...
"exceptions" {return tt.ktt(131);}
"exception_init" {return tt.ktt(132);}
...
"format" {return tt.ktt(150);}
"forward" {return tt.ktt(151);}
"found" {return tt.ktt(152);}
"from" {return tt.ktt(153);}
"full" {return tt.ktt(154);}
"function" {return tt.ktt(155);}
"f_ratio" {return tt.ktt(156);}
"goto" {return tt.ktt(157);}
"grant" {return tt.ktt(158);}
"group" {return tt.ktt(159);}
"hash" {return tt.ktt(160);}
"having" {return tt.ktt(161);}
"heap" {return tt.ktt(162);}
"hide" {return tt.ktt(163);}
"hour" {return tt.ktt(164);}
"if" {return tt.ktt(165);}
"ignore" {return tt.ktt(166);}
"immediate" {return tt.ktt(167);}
"in" {return tt.ktt(168);}
"include" {return tt.ktt(169);}
"increment" {return tt.ktt(170);}
"indent" {return tt.ktt(171);}
"index" {return tt.ktt(172);}
"indicator" {return tt.ktt(173);}
"indices" {return tt.ktt(174);}
"infinite" {return tt.ktt(175);}
"inline" {return tt.ktt(176);}
"inner" {return tt.ktt(177);}
"insert" {return tt.ktt(178);}
"inserting" {return tt.ktt(179);}
"instantiable" {return tt.ktt(180);}
"instead" {return tt.ktt(181);}
"interface" {return tt.ktt(182);}
"intersect" {return tt.ktt(183);}
"interval" {return tt.ktt(184);}
"into" {return tt.ktt(185);}
"is" {return tt.ktt(186);}
"isolation" {return tt.ktt(187);}
"isopen" {return tt.ktt(188);}
"iterate" {return tt.ktt(189);}
"java" {return tt.ktt(190);}
"join" {return tt.ktt(191);}
"json" {return tt.ktt(192);}
"keep" {return tt.ktt(193);}
"key" {return tt.ktt(194);}
"keys" {return tt.ktt(195);}
"language" {return tt.ktt(196);}
"last" {return tt.ktt(197);}
"leading" {return tt.ktt(198);}
"left" {return tt.ktt(199);}
"level" {return tt.ktt(200);}
"library" {return tt.ktt(201);}
"like" {return tt.ktt(202);}
"like2" {return tt.ktt(203);}
"like4" {return tt.ktt(204);}
"likec" {return tt.ktt(205);}
"limit" {return tt.ktt(206);}
"limited" {return tt.ktt(207);}
"local" {return tt.ktt(208);}
"lock" {return tt.ktt(209);}
"locked" {return tt.ktt(210);}
"log" {return tt.ktt(211);}
"logoff" {return tt.ktt(212);}
"logon" {return tt.ktt(213);}
"loop" {return tt.ktt(214);}
"main" {return tt.ktt(215);}
"map" {return tt.ktt(216);}
"matched" {return tt.ktt(217);}
"maxlen" {return tt.ktt(218);}
"maxvalue" {return tt.ktt(219);}
"mean_squares_between" {return tt.ktt(220);}
"mean_squares_within" {return tt.ktt(221);}
"measures" {return tt.ktt(222);}
"member" {return tt.ktt(223);}
"merge" {return tt.ktt(224);}
"metadata" {return tt.ktt(225);}
"minus" {return tt.ktt(226);}
"minute" {return tt.ktt(227);}
"minvalue" {return tt.ktt(228);}
"mismatch" {return tt.ktt(229);}
"mlslabel" {return tt.ktt(230);}
"mode" {return tt.ktt(231);}
"model" {return tt.ktt(232);}
"month" {return tt.ktt(233);}
"multiset" {return tt.ktt(234);}
"name" {return tt.ktt(235);}
"nan" {return tt.ktt(236);}
"natural" {return tt.ktt(237);}
"naturaln" {return tt.ktt(238);}
"nav" {return tt.ktt(239);}
"nchar_cs" {return tt.ktt(240);}
"nested" {return tt.ktt(241);}
"new" {return tt.ktt(242);}
"next" {return tt.ktt(243);}
"nextval" {return tt.ktt(244);}
"no" {return tt.ktt(245);}
"noaudit" {return tt.ktt(246);}
"nocopy" {return tt.ktt(247);}
"nocycle" {return tt.ktt(248);}
"noentityescaping" {return tt.ktt(249);}
"none" {return tt.ktt(250);}
"noneditionable" {return tt.ktt(251);}
"noschemacheck" {return tt.ktt(252);}
"not" {return tt.ktt(253);}
"notfound" {return tt.ktt(254);}
"nowait" {return tt.ktt(255);}
"null" {return tt.ktt(256);}
"nulls" {return tt.ktt(257);}
"number_base" {return tt.ktt(258);}
"object" {return tt.ktt(259);}
"ocirowid" {return tt.ktt(260);}
"of" {return tt.ktt(261);}
"offset" {return tt.ktt(262);}
"oid" {return tt.ktt(263);}
"old" {return tt.ktt(264);}
"on" {return tt.ktt(265);}
"one_sided_prob_or_less" {return tt.ktt(266);}
"one_sided_prob_or_more" {return tt.ktt(267);}
"one_sided_sig" {return tt.ktt(268);}
"only" {return tt.ktt(269);}
"opaque" {return tt.ktt(270);}
"open" {return tt.ktt(271);}
"operator" {return tt.ktt(272);}
"option" {return tt.ktt(273);}
"or" {return tt.ktt(274);}
"order" {return tt.ktt(275);}
"ordinality" {return tt.ktt(276);}
"organization" {return tt.ktt(277);}
"others" {return tt.ktt(278);}
"out" {return tt.ktt(279);}
"outer" {return tt.ktt(280);}
"over" {return tt.ktt(281);}
"overflow" {return tt.ktt(282);}
"overlaps" {return tt.ktt(283);}
"overriding" {return tt.ktt(284);}
"package" {return tt.ktt(285);}
"parallel_enable" {return tt.ktt(286);}
"parameters" {return tt.ktt(287);}
"parent" {return tt.ktt(288);}
"partition" {return tt.ktt(289);}
"passing" {return tt.ktt(290);}
"path" {return tt.ktt(291);}
"pctfree" {return tt.ktt(292);}
"percent" {return tt.ktt(293);}
"period" {return tt.ktt(294);}
"phi_coefficient" {return tt.ktt(295);}
"pipe" {return tt.ktt(296);}
"pipelined" {return tt.ktt(297);}
"pivot" {return tt.ktt(298);}
"pluggable" {return tt.ktt(299);}
"positive" {return tt.ktt(300);}
"positiven" {return tt.ktt(301);}
"power" {return tt.ktt(302);}
"pragma" {return tt.ktt(303);}
"precedes" {return tt.ktt(304);}
"preceding" {return tt.ktt(305);}
"present" {return tt.ktt(306);}
"pretty" {return tt.ktt(307);}
"prior" {return tt.ktt(308);}
"private" {return tt.ktt(309);}
"procedure" {return tt.ktt(310);}
"public" {return tt.ktt(311);}
"raise" {return tt.ktt(312);}
"range" {return tt.ktt(313);}
"read" {return tt.ktt(314);}
"record" {return tt.ktt(315);}
"ref" {return tt.ktt(316);}
"reference" {return tt.ktt(317);}
"referencing" {return tt.ktt(318);}
"regexp_like" {return tt.ktt(319);}
"reject" {return tt.ktt(320);}
"release" {return tt.ktt(321);}
"relies_on" {return tt.ktt(322);}
"remainder" {return tt.ktt(323);}
"rename" {return tt.ktt(324);}
"replace" {return tt.ktt(325);}
"restrict_references" {return tt.ktt(326);}
"result" {return tt.ktt(327);}
"result_cache" {return tt.ktt(328);}
"return" {return tt.ktt(329);}
"returning" {return tt.ktt(330);}
"reverse" {return tt.ktt(331);}
"revoke" {return tt.ktt(332);}
"right" {return tt.ktt(333);}
"rnds" {return tt.ktt(334);}
"rnps" {return tt.ktt(335);}
"rollback" {return tt.ktt(336);}
"rollup" {return tt.ktt(337);}
"row" {return tt.ktt(338);}
"rowcount" {return tt.ktt(339);}
"rownum" {return tt.ktt(340);}
"rows" {return tt.ktt(341);}
"rowtype" {return tt.ktt(342);}
"rules" {return tt.ktt(343);}
"sample" {return tt.ktt(344);}
"save" {return tt.ktt(345);}
"savepoint" {return tt.ktt(346);}
"schema" {return tt.ktt(347);}
"schemacheck" {return tt.ktt(348);}
"scn" {return tt.ktt(349);}
"second" {return tt.ktt(350);}
"seed" {return tt.ktt(351);}
"segment" {return tt.ktt(352);}
"select" {return tt.ktt(353);}
"self" {return tt.ktt(354);}
"separate" {return tt.ktt(355);}
"sequential" {return tt.ktt(356);}
"serializable" {return tt.ktt(357);}
"serially_reusable" {return tt.ktt(358);}
"servererror" {return tt.ktt(359);}
"set" {return tt.ktt(360);}
"sets" {return tt.ktt(361);}
"share" {return tt.ktt(362);}
"sharing" {return tt.ktt(363);}
"show" {return tt.ktt(364);}
"shutdown" {return tt.ktt(365);}
"siblings" {return tt.ktt(366);}
"sig" {return tt.ktt(367);}
"single" {return tt.ktt(368);}
"size" {return tt.ktt(369);}
"skip" {return tt.ktt(370);}
"some" {return tt.ktt(371);}
"space" {return tt.ktt(372);}
"sql" {return tt.ktt(373);}
"sqlcode" {return tt.ktt(374);}
"sqlerrm" {return tt.ktt(375);}
"standalone" {return tt.ktt(376);}
"start" {return tt.ktt(377);}
"startup" {return tt.ktt(378);}
"statement" {return tt.ktt(379);}
"static" {return tt.ktt(380);}
"statistic" {return tt.ktt(381);}
"statistics" {return tt.ktt(382);}
"strict" {return tt.ktt(383);}
"struct" {return tt.ktt(384);}
"submultiset" {return tt.ktt(385);}
"subpartition" {return tt.ktt(386);}
"subtype" {return tt.ktt(387);}
"successful" {return tt.ktt(388);}
"sum_squares_between" {return tt.ktt(389);}
"sum_squares_within" {return tt.ktt(390);}
"suspend" {return tt.ktt(391);}
"synonym" {return tt.ktt(392);}
"table" {return tt.ktt(393);}
"tdo" {return tt.ktt(394);}
"then" {return tt.ktt(395);}
"ties" {return tt.ktt(396);}
"time" {return tt.ktt(397);}
"timezone_abbr" {return tt.ktt(398);}
"timezone_hour" {return tt.ktt(399);}
"timezone_minute" {return tt.ktt(400);}
"timezone_region" {return tt.ktt(401);}
"to" {return tt.ktt(402);}
"trailing" {return tt.ktt(403);}
"transaction" {return tt.ktt(404);}
"trigger" {return tt.ktt(405);}
"true" {return tt.ktt(406);}
"truncate" {return tt.ktt(407);}
"trust" {return tt.ktt(408);}
"two_sided_prob" {return tt.ktt(409);}
"two_sided_sig" {return tt.ktt(410);}
"type" {return tt.ktt(411);}
"unbounded" {return tt.ktt(412);}
"unconditional" {return tt.ktt(413);}
"under" {return tt.ktt(414);}
"under_path" {return tt.ktt(415);}
"union" {return tt.ktt(416);}
"unique" {return tt.ktt(417);}
"unlimited" {return tt.ktt(418);}
"unpivot" {return tt.ktt(419);}
"unplug" {return tt.ktt(420);}
"until" {return tt.ktt(421);}
"update" {return tt.ktt(422);}
"updated" {return tt.ktt(423);}
"updating" {return tt.ktt(424);}
"upsert" {return tt.ktt(425);}
"use" {return tt.ktt(426);}
"user" {return tt.ktt(427);}
"using" {return tt.ktt(428);}
"u_statistic" {return tt.ktt(429);}
"validate" {return tt.ktt(430);}
"value" {return tt.ktt(431);}
"values" {return tt.ktt(432);}
"variable" {return tt.ktt(433);}
"varray" {return tt.ktt(434);}
"varying" {return tt.ktt(435);}
"version" {return tt.ktt(436);}
"versions" {return tt.ktt(437);}
"view" {return tt.ktt(438);}
"wait" {return tt.ktt(439);}
"wellformed" {return tt.ktt(440);}
"when" {return tt.ktt(441);}
"whenever" {return tt.ktt(442);}
"where" {return tt.ktt(443);}
"while" {return tt.ktt(444);}
"with" {return tt.ktt(445);}
"within" {return tt.ktt(446);}
"without" {return tt.ktt(447);}
"wnds" {return tt.ktt(448);}
"wnps" {return tt.ktt(449);}
"work" {return tt.ktt(450);}
"wrapped" {return tt.ktt(451);}
"wrapper" {return tt.ktt(452);}
"write" {return tt.ktt(453);}
"xml" {return tt.ktt(454);}
"xmlnamespaces" {return tt.ktt(455);}
"year" {return tt.ktt(456);}
"yes" {return tt.ktt(457);}
"zone" {return tt.ktt(458);}
// MARKER_END_KEYWORDS
