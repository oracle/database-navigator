...
SQL_KEYWORD = "abort"|"always"|"action"|"add"|"after"|"all"|"alter"|"analyze"|"and"|"as"|"asc"|"attach"|"autoincrement"|"before"|"begin"|"between"|"by"|"cascade"|"case"|"cast"|"check"|"collate"|"column"|"commit"|"conflict"|"constraint"|"create"|"cross"|"current_date"|"current_time"|"current_timestamp"|"current"|"database"|"default"|"deferrable"|"deferred"|"delete"|"desc"|"detach"|"distinct"|"do"|"drop"|"exclude"|"each"|"else"|"end"|"escape"|"except"|"exclusive"|"exists"|"explain"|"fail"|"file"|"false"|"filter"|"for"|"foreign"|"following"|"from"|"full"|"generated"|"glob"|"group"|"groups"|"having"|"if"|"ignore"|"immediate"|"in"|"index"|"indexed"|"initially"|"inner"|"incremental"|"insert"|"instead"|"intersect"|"into"|"is"|"isnull"|"join"|"key"|"left"|"like"|"limit"|"match"|"materialized"|"memory"|"natural"|"n"|"no"|"none"|"not"|"nothing"|"notnull"|"normal"|"null"|"of"|"off"|"offset"|"on"|"or"|"order"|"others"|"outer"|"over"|"passive"|"persist"|"partition"|"plan"|"pragma"|"preceding"|"primary"|"query"|"raise"|"recursive"|"references"|"range"|"regexp"|"reindex"|"release"|"rename"|"replace"|"restrict"|"restart"|"returning"|"right"|"rollback"|"rows"|"row"|"rowid"|"savepoint"|"select"|"set"|"strict"|"stored"|"table"|"temp"|"temporary"|"then"|"ties"|"to"|"transaction"|"trigger"|"true"|"truncate"|"union"|"unique"|"unbounded"|"update"|"using"|"utf-8"|"utf-16"|"utf-16be"|"utf-16le"|"vacuum"|"values"|"window"|"view"|"virtual"|"wal"|"when"|"where"|"with"|"without"
