...
SQL_DATATYPE = "bit"|"tinyint"|"bool"|"boolean"|"smallint"|"mediumint"|"int"|"integer"|"bigint"|"double"{ws}"precision"|"double"|"real"|"float"|"decimal"|"dec"|"numeric"|"fixed"|"date"|"datetime"|"timestamp"|"time"|"year"|"varchar"|"national"{ws}"varchar"|"binary"|"varbinary"|"tinyblob"|"tinytext"|"blob"|"text"|"mediumblob"|"mediumtext"|"longblob"|"longtext"|"enum"
