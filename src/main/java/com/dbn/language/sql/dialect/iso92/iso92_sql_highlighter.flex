...
SQL_KEYWORD = "accessible"|"add"|"all"|"alter"|"analyze"|"and"|"any"|"as"|"asc"|"assertion"|"asensitive"|"authorization"|"before"|"between"|"both"|"by"|"call"|"cascade"|"cascaded"|"case"|"cast"|"change"|"check"|"close"|"collate"|"column"|"columns"|"commit"|"committed"|"concurrent"|"condition"|"constraint"|"continue"|"convert"|"create"|"cross"|"cursor"|"data"|"database"|"databases"|"day"|"declare"|"default"|"delayed"|"delete"|"desc"|"describe"|"deterministic"|"distinct"|"distinctrow"|"div"|"do"|"domain"|"drop"|"dual"|"dumpfile"|"duplicate"|"each"|"else"|"elseif"|"enclosed"|"end"|"escape"|"escaped"|"exists"|"exit"|"expansion"|"explain"|"false"|"fetch"|"fields"|"first"|"float4"|"float8"|"for"|"force"|"foreign"|"from"|"full"|"fulltext"|"grant"|"group"|"handler"|"having"|"high_priority"|"hour"|"if"|"ignore"|"in"|"index"|"indicator"|"infile"|"inner"|"inout"|"insensitive"|"insert"|"int1"|"int2"|"int3"|"int4"|"int8"|"into"|"is"|"isolation"|"iterate"|"join"|"key"|"keys"|"kill"|"language"|"last"|"leading"|"leave"|"left"|"level"|"like"|"limit"|"linear"|"lines"|"load"|"local"|"lock"|"long"|"loop"|"low_ignore"|"low_priority"|"master_ssl_verify_server_cert"|"match"|"microsecond"|"middleint"|"minute"|"mod"|"mode"|"modifies"|"month"|"national"|"natural"|"next"|"not"|"no_write_to_binlog"|"null"|"offset"|"oj"|"on"|"only"|"open"|"optimize"|"option"|"optionally"|"or"|"order"|"out"|"outer"|"outfile"|"overlaps"|"partial"|"precision"|"prev"|"primary"|"privileges"|"procedure"|"public"|"purge"|"query"|"quick"|"range"|"read"|"reads"|"read_only"|"read_write"|"references"|"regexp"|"release"|"rename"|"repeat"|"repeatable"|"replace"|"require"|"restrict"|"return"|"reverse"|"revoke"|"right"|"rlike"|"rollback"|"rollup"|"schema"|"schemas"|"second"|"select"|"sensitive"|"separator"|"serializable"|"set"|"share"|"show"|"simple"|"some"|"spatial"|"specific"|"sql"|"sqlexception"|"sqlstate"|"sqlwarning"|"sql_big_result"|"sql_buffer_result"|"sql_cache"|"sql_calc_found_rows"|"sql_no_cache"|"sql_small_result"|"ssl"|"starting"|"straight_join"|"table"|"terminated"|"then"|"to"|"trailing"|"transaction"|"trigger"|"true"|"truncate"|"undo"|"union"|"unique"|"uncommitted"|"unknown"|"unlock"|"unsigned"|"update"|"usage"|"use"|"using"|"value"|"values"|"varcharacter"|"varying"|"view"|"when"|"where"|"while"|"with"|"without"|"work"|"write"|"xor"|"zerofill"|"zone"
