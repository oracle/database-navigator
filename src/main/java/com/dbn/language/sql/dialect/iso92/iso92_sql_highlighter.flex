...
SQL_KEYWORD = "absolute"|"action"|"add"|"all"|"allocate"|"alter"|"and"|"any"|"as"|"asc"|"assertion"|"asensitive"|"authorization"|"before"|"between"|"both"|"by"|"call"|"cascade"|"cascaded"|"case"|"catalog"|"cast"|"characteristics"|"check"|"close"|"collate"|"column"|"columns"|"commit"|"committed"|"concurrent"|"connect"|"connection"|"condition"|"constraint"|"constraints"|"continue"|"convert"|"corresponding"|"create"|"cross"|"current"|"cursor"|"data"|"day"|"declare"|"default"|"deferrable"|"deferred"|"deallocate"|"delete"|"desc"|"describe"|"descriptor"|"deterministic"|"diagnostics"|"disconnect"|"distinct"|"do"|"domain"|"drop"|"each"|"else"|"elseif"|"end"|"escape"|"except"|"execute"|"exists"|"exit"|"expansion"|"false"|"fetch"|"first"|"for"|"foreign"|"from"|"full"|"get"|"global"|"grant"|"group"|"handler"|"having"|"hold"|"hour"|"if"|"immediate"|"in"|"index"|"indicator"|"inner"|"inout"|"input"|"insensitive"|"insert"|"initially"|"into"|"is"|"isolation"|"intersect"|"iterate"|"join"|"key"|"language"|"last"|"leading"|"leave"|"left"|"level"|"like"|"local"|"lock"|"long"|"loop"|"match"|"microsecond"|"minute"|"mod"|"mode"|"modifies"|"month"|"national"|"names"|"natural"|"next"|"no"|"not"|"null"|"offset"|"of"|"oj"|"on"|"only"|"open"|"option"|"optionally"|"or"|"order"|"out"|"outer"|"output"|"overlaps"|"partial"|"precision"|"prepare"|"prev"|"primary"|"prior"|"privileges"|"procedure"|"public"|"query"|"range"|"read"|"reads"|"read_only"|"read_write"|"references"|"release"|"relative"|"rename"|"repeat"|"repeatable"|"restrict"|"return"|"revoke"|"right"|"rollback"|"schema"|"schemas"|"scroll"|"second"|"select"|"sensitive"|"separator"|"serializable"|"session"|"set"|"share"|"show"|"simple"|"size"|"some"|"specific"|"sql"|"sqlexception"|"sqlstate"|"sqlwarning"|"starting"|"table"|"time"|"then"|"to"|"trailing"|"transaction"|"trigger"|"true"|"truncate"|"undo"|"union"|"unique"|"uncommitted"|"unknown"|"update"|"usage"|"using"|"value"|"values"|"varcharacter"|"varying"|"view"|"when"|"where"|"while"|"with"|"without"|"work"|"write"|"year"|"zone"
