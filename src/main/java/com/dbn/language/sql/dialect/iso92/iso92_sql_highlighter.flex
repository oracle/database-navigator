...
SQL_KEYWORD = "accessible"|"absolute"|"action"|"add"|"all"|"alter"|"analyze"|"and"|"any"|"as"|"asc"|"assertion"|"asensitive"|"authorization"|"before"|"between"|"both"|"by"|"call"|"cascade"|"cascaded"|"case"|"catalog"|"cast"|"change"|"characteristics"|"check"|"close"|"collate"|"column"|"columns"|"commit"|"committed"|"concurrent"|"condition"|"constraint"|"constraints"|"continue"|"convert"|"corresponding"|"create"|"cross"|"current"|"cursor"|"data"|"database"|"databases"|"day"|"declare"|"default"|"deferrable"|"deferred"|"delayed"|"delete"|"desc"|"describe"|"deterministic"|"diagnostics"|"distinct"|"distinctrow"|"div"|"do"|"domain"|"drop"|"dual"|"dumpfile"|"duplicate"|"each"|"else"|"elseif"|"enclosed"|"end"|"escape"|"escaped"|"except"|"exists"|"exit"|"expansion"|"explain"|"false"|"fetch"|"fields"|"first"|"float4"|"float8"|"for"|"force"|"foreign"|"from"|"full"|"fulltext"|"get"|"grant"|"group"|"handler"|"having"|"high_priority"|"hold"|"hour"|"if"|"ignore"|"immediate"|"in"|"index"|"indicator"|"infile"|"inner"|"inout"|"insensitive"|"insert"|"int1"|"int2"|"int3"|"int4"|"int8"|"into"|"is"|"isolation"|"intersect"|"iterate"|"join"|"key"|"keys"|"kill"|"language"|"last"|"leading"|"leave"|"left"|"level"|"like"|"limit"|"linear"|"lines"|"load"|"local"|"lock"|"long"|"loop"|"low_ignore"|"low_priority"|"master_ssl_verify_server_cert"|"match"|"microsecond"|"middleint"|"minute"|"mod"|"mode"|"modifies"|"month"|"national"|"names"|"natural"|"next"|"no"|"not"|"no_write_to_binlog"|"null"|"offset"|"of"|"oj"|"on"|"only"|"open"|"optimize"|"option"|"optionally"|"or"|"order"|"out"|"outer"|"outfile"|"overlaps"|"partial"|"precision"|"prev"|"primary"|"prior"|"privileges"|"procedure"|"public"|"purge"|"query"|"quick"|"range"|"read"|"reads"|"read_only"|"read_write"|"references"|"regexp"|"release"|"relative"|"rename"|"repeat"|"repeatable"|"replace"|"require"|"restrict"|"return"|"reverse"|"revoke"|"right"|"rlike"|"rollback"|"rollup"|"schema"|"schemas"|"scroll"|"second"|"select"|"sensitive"|"separator"|"serializable"|"session"|"set"|"share"|"show"|"simple"|"size"|"some"|"spatial"|"specific"|"sql"|"sqlexception"|"sqlstate"|"sqlwarning"|"sql_big_result"|"sql_buffer_result"|"sql_cache"|"sql_calc_found_rows"|"sql_no_cache"|"sql_small_result"|"ssl"|"starting"|"straight_join"|"table"|"time"|"terminated"|"then"|"to"|"trailing"|"transaction"|"trigger"|"true"|"truncate"|"undo"|"union"|"unique"|"uncommitted"|"unknown"|"unlock"|"unsigned"|"update"|"usage"|"use"|"using"|"value"|"values"|"varcharacter"|"varying"|"view"|"when"|"where"|"while"|"with"|"without"|"work"|"write"|"xor"|"zerofill"|"zone"
