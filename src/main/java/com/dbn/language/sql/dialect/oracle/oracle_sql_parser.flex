...
"ordinality" {return tt.ktt(448);}
"organization" {return tt.ktt(449);}
"outer" {return tt.ktt(450);}
"outline" {return tt.ktt(451);}
"over" {return tt.ktt(452);}
"overflow" {return tt.ktt(453);}
"overlaps" {return tt.ktt(454);}
"package" {return tt.ktt(455);}
"parallel" {return tt.ktt(456);}
"parameters" {return tt.ktt(457);}
"partial" {return tt.ktt(458);}
"partition" {return tt.ktt(459);}
"partitions" {return tt.ktt(460);}
"passing" {return tt.ktt(461);}
"password" {return tt.ktt(462);}
"path" {return tt.ktt(463);}
"pctfree" {return tt.ktt(464);}
"pctincrease" {return tt.ktt(465);}
"pctthreshold" {return tt.ktt(466);}
"pctused" {return tt.ktt(467);}
"pctversion" {return tt.ktt(468);}
"percent" {return tt.ktt(469);}
"performance" {return tt.ktt(470);}
"period" {return tt.ktt(471);}
"phi_coefficient" {return tt.ktt(472);}
"physical" {return tt.ktt(473);}
"pivot" {return tt.ktt(474);}
"plan" {return tt.ktt(475);}
"pluggable" {return tt.ktt(476);}
"policy" {return tt.ktt(477);}
"post_transaction" {return tt.ktt(478);}
"power" {return tt.ktt(479);}
"prebuilt" {return tt.ktt(480);}
"preceding" {return tt.ktt(481);}
"precision" {return tt.ktt(482);}
"prepare" {return tt.ktt(483);}
"present" {return tt.ktt(484);}
"preserve" {return tt.ktt(485);}
"pretty" {return tt.ktt(486);}
"primary" {return tt.ktt(487);}
"prior" {return tt.ktt(488);}
"priority" {return tt.ktt(489);}
"private" {return tt.ktt(490);}
"privilege" {return tt.ktt(491);}
"privileges" {return tt.ktt(492);}
"procedure" {return tt.ktt(493);}
"process" {return tt.ktt(494);}
"profile" {return tt.ktt(495);}
"program" {return tt.ktt(496);}
"protection" {return tt.ktt(497);}
"public" {return tt.ktt(498);}
"purge" {return tt.ktt(499);}
"query" {return tt.ktt(500);}
"queue" {return tt.ktt(501);}
"quiesce" {return tt.ktt(502);}
"quota" {return tt.ktt(503);}
"range" {return tt.ktt(504);}
"read" {return tt.ktt(505);}
"reads" {return tt.ktt(506);}
"rebalance" {return tt.ktt(507);}
"rebuild" {return tt.ktt(508);}
"recover" {return tt.ktt(509);}
"recovery" {return tt.ktt(510);}
"recycle" {return tt.ktt(511);}
"redefine" {return tt.ktt(512);}
"reduced" {return tt.ktt(513);}
"ref" {return tt.ktt(514);}
"reference" {return tt.ktt(515);}
"references" {return tt.ktt(516);}
"refresh" {return tt.ktt(517);}
"regexp_like" {return tt.ktt(518);}
"register" {return tt.ktt(519);}
"reject" {return tt.ktt(520);}
"relational" {return tt.ktt(521);}
"rely" {return tt.ktt(522);}
"remainder" {return tt.ktt(523);}
"rename" {return tt.ktt(524);}
"repair" {return tt.ktt(525);}
"repeat" {return tt.ktt(526);}
"replace" {return tt.ktt(527);}
"replication" {return tt.ktt(528);}
"reset" {return tt.ktt(529);}
"resetlogs" {return tt.ktt(530);}
"resize" {return tt.ktt(531);}
"resolve" {return tt.ktt(532);}
"resolver" {return tt.ktt(533);}
"resource" {return tt.ktt(534);}
"restrict" {return tt.ktt(535);}
"restricted" {return tt.ktt(536);}
"resumable" {return tt.ktt(537);}
"resume" {return tt.ktt(538);}
"retention" {return tt.ktt(539);}
"return" {return tt.ktt(540);}
"returning" {return tt.ktt(541);}
"reuse" {return tt.ktt(542);}
"reverse" {return tt.ktt(543);}
"revoke" {return tt.ktt(544);}
"rewrite" {return tt.ktt(545);}
"right" {return tt.ktt(546);}
"role" {return tt.ktt(547);}
"rollback" {return tt.ktt(548);}
"rollover" {return tt.ktt(549);}
"rollup" {return tt.ktt(550);}
"row" {return tt.ktt(551);}
"rownum" {return tt.ktt(552);}
"rows" {return tt.ktt(553);}
"rule" {return tt.ktt(554);}
"rules" {return tt.ktt(555);}
"salt" {return tt.ktt(556);}
"sample" {return tt.ktt(557);}
"savepoint" {return tt.ktt(558);}
"scan" {return tt.ktt(559);}
"scheduler" {return tt.ktt(560);}
"schemacheck" {return tt.ktt(561);}
"scn" {return tt.ktt(562);}
"scope" {return tt.ktt(563);}
"second" {return tt.ktt(564);}
"seed" {return tt.ktt(565);}
"segment" {return tt.ktt(566);}
"select" {return tt.ktt(567);}
"sequence" {return tt.ktt(568);}
"sequential" {return tt.ktt(569);}
"serializable" {return tt.ktt(570);}
"service" {return tt.ktt(571);}
"session" {return tt.ktt(572);}
"set" {return tt.ktt(573);}
"sets" {return tt.ktt(574);}
"settings" {return tt.ktt(575);}
"share" {return tt.ktt(576);}
"shared" {return tt.ktt(577);}
"shared_pool" {return tt.ktt(578);}
"sharing" {return tt.ktt(579);}
"show" {return tt.ktt(580);}
"showprompt" {return tt.ktt(581);}
"showsql" {return tt.ktt(582);}
"shrink" {return tt.ktt(583);}
"shutdown" {return tt.ktt(584);}
"siblings" {return tt.ktt(585);}
"sid" {return tt.ktt(586);}
"sig" {return tt.ktt(587);}
"single" {return tt.ktt(588);}
"size" {return tt.ktt(589);}
"skip" {return tt.ktt(590);}
"smallfile" {return tt.ktt(591);}
"snapshot" {return tt.ktt(592);}
"some" {return tt.ktt(593);}
"sort" {return tt.ktt(594);}
"source" {return tt.ktt(595);}
"space" {return tt.ktt(596);}
"specification" {return tt.ktt(597);}
"spfile" {return tt.ktt(598);}
"split" {return tt.ktt(599);}
"sql" {return tt.ktt(600);}
"standalone" {return tt.ktt(601);}
"standby" {return tt.ktt(602);}
"start" {return tt.ktt(603);}
"statement" {return tt.ktt(604);}
"statistic" {return tt.ktt(605);}
"statistics" {return tt.ktt(606);}
"stop" {return tt.ktt(607);}
"storage" {return tt.ktt(608);}
"store" {return tt.ktt(609);}
"strict" {return tt.ktt(610);}
"submultiset" {return tt.ktt(611);}
"subpartition" {return tt.ktt(612);}
"subpartitions" {return tt.ktt(613);}
"substitutable" {return tt.ktt(614);}
"successful" {return tt.ktt(615);}
"sum_squares_between" {return tt.ktt(616);}
"sum_squares_within" {return tt.ktt(617);}
"supplemental" {return tt.ktt(618);}
"suspend" {return tt.ktt(619);}
"switch" {return tt.ktt(620);}
"switchover" {return tt.ktt(621);}
"synchronous" {return tt.ktt(622);}
"synonym" {return tt.ktt(623);}
"sysbackup" {return tt.ktt(624);}
"sysdba" {return tt.ktt(625);}
"sysdg" {return tt.ktt(626);}
"syskm" {return tt.ktt(627);}
"sysoper" {return tt.ktt(628);}
"system" {return tt.ktt(629);}
"table" {return tt.ktt(630);}
"tables" {return tt.ktt(631);}
"tablespace" {return tt.ktt(632);}
"tempfile" {return tt.ktt(633);}
"template" {return tt.ktt(634);}
"temporary" {return tt.ktt(635);}
"test" {return tt.ktt(636);}
"than" {return tt.ktt(637);}
"then" {return tt.ktt(638);}
"thread" {return tt.ktt(639);}
"through" {return tt.ktt(640);}
"tier" {return tt.ktt(641);}
"ties" {return tt.ktt(642);}
"time" {return tt.ktt(643);}
"time_zone" {return tt.ktt(644);}
"timeout" {return tt.ktt(645);}
"timezone_abbr" {return tt.ktt(646);}
"timezone_hour" {return tt.ktt(647);}
"timezone_minute" {return tt.ktt(648);}
"timezone_region" {return tt.ktt(649);}
"to" {return tt.ktt(650);}
"trace" {return tt.ktt(651);}
"tracking" {return tt.ktt(652);}
"trailing" {return tt.ktt(653);}
"transaction" {return tt.ktt(654);}
"translation" {return tt.ktt(655);}
"trigger" {return tt.ktt(656);}
"truncate" {return tt.ktt(657);}
"trusted" {return tt.ktt(658);}
"tuning" {return tt.ktt(659);}
"two_sided_prob" {return tt.ktt(660);}
"two_sided_sig" {return tt.ktt(661);}
"type" {return tt.ktt(662);}
"u_statistic" {return tt.ktt(663);}
"uid" {return tt.ktt(664);}
"unarchived" {return tt.ktt(665);}
"unbounded" {return tt.ktt(666);}
"unconditional" {return tt.ktt(667);}
"under" {return tt.ktt(668);}
"under_path" {return tt.ktt(669);}
"undrop" {return tt.ktt(670);}
"union" {return tt.ktt(671);}
"unique" {return tt.ktt(672);}
"unlimited" {return tt.ktt(673);}
"unlock" {return tt.ktt(674);}
"unnest" {return tt.ktt(675);}
"unpivot" {return tt.ktt(676);}
"unprotected" {return tt.ktt(677);}
"unquiesce" {return tt.ktt(678);}
"unrecoverable" {return tt.ktt(679);}
"until" {return tt.ktt(680);}
"unusable" {return tt.ktt(681);}
"unused" {return tt.ktt(682);}
"update" {return tt.ktt(683);}
"updated" {return tt.ktt(684);}
"upgrade" {return tt.ktt(685);}
"upsert" {return tt.ktt(686);}
"usage" {return tt.ktt(687);}
"use" {return tt.ktt(688);}
"user" {return tt.ktt(689);}
"using" {return tt.ktt(690);}
"validate" {return tt.ktt(691);}
"validation" {return tt.ktt(692);}
"value" {return tt.ktt(693);}
"values" {return tt.ktt(694);}
"varray" {return tt.ktt(695);}
"version" {return tt.ktt(696);}
"versions" {return tt.ktt(697);}
"view" {return tt.ktt(698);}
"visible" {return tt.ktt(699);}
"wait" {return tt.ktt(700);}
"wellformed" {return tt.ktt(701);}
"when" {return tt.ktt(702);}
"whenever" {return tt.ktt(703);}
"where" {return tt.ktt(704);}
"with" {return tt.ktt(705);}
"within" {return tt.ktt(706);}
"without" {return tt.ktt(707);}
"work" {return tt.ktt(708);}
"wrapper" {return tt.ktt(709);}
"write" {return tt.ktt(710);}
"xml" {return tt.ktt(711);}
"xmlnamespaces" {return tt.ktt(712);}
"xmlschema" {return tt.ktt(713);}
"xmltype" {return tt.ktt(714);}
"year" {return tt.ktt(715);}
"years" {return tt.ktt(716);}
"yes" {return tt.ktt(717);}
"zone" {return tt.ktt(718);}
"false" {return tt.ktt(719);}
"true" {return tt.ktt(720);}
