...
"character"{ws}"varying" {return tt.dtt(7);}
...
"like2" {return tt.ktt(342);}
"like4" {return tt.ktt(343);}
"like" {return tt.ktt(344);}
...
"instr2" {return tt.ftt(61);}
"instr4" {return tt.ftt(62);}
"instr" {return tt.ftt(63);}
