...
"close" {return tt.ktt(25);}
"collate" {return tt.ktt(26);}
"column" {return tt.ktt(27);}
"columns" {return tt.ktt(28);}
"commit" {return tt.ktt(29);}
"committed" {return tt.ktt(30);}
"concurrent" {return tt.ktt(31);}
"connect" {return tt.ktt(32);}
"connection" {return tt.ktt(33);}
...
"day" {return tt.ktt(45);}
"declare" {return tt.ktt(46);}
"default" {return tt.ktt(47);}
"deferrable" {return tt.ktt(48);}
"deferred" {return tt.ktt(49);}
"deallocate" {return tt.ktt(50);}
"delete" {return tt.ktt(51);}
"desc" {return tt.ktt(52);}
"describe" {return tt.ktt(53);}
"descriptor" {return tt.ktt(54);}
"deterministic" {return tt.ktt(55);}
"diagnostics" {return tt.ktt(56);}
"disconnect" {return tt.ktt(57);}
"distinct" {return tt.ktt(58);}
"do" {return tt.ktt(59);}
"domain" {return tt.ktt(60);}
"drop" {return tt.ktt(61);}
"each" {return tt.ktt(62);}
"else" {return tt.ktt(63);}
"elseif" {return tt.ktt(64);}
"end" {return tt.ktt(65);}
"escape" {return tt.ktt(66);}
"except" {return tt.ktt(67);}
"execute" {return tt.ktt(68);}
"exists" {return tt.ktt(69);}
"exit" {return tt.ktt(70);}
"expansion" {return tt.ktt(71);}
"false" {return tt.ktt(72);}
"fetch" {return tt.ktt(73);}
"first" {return tt.ktt(74);}
"for" {return tt.ktt(75);}
"foreign" {return tt.ktt(76);}
"from" {return tt.ktt(77);}
"full" {return tt.ktt(78);}
"get" {return tt.ktt(79);}
"global" {return tt.ktt(80);}
"grant" {return tt.ktt(81);}
"group" {return tt.ktt(82);}
"handler" {return tt.ktt(83);}
"having" {return tt.ktt(84);}
"hold" {return tt.ktt(85);}
"hour" {return tt.ktt(86);}
"if" {return tt.ktt(87);}
"immediate" {return tt.ktt(88);}
"in" {return tt.ktt(89);}
"index" {return tt.ktt(90);}
"indicator" {return tt.ktt(91);}
"inner" {return tt.ktt(92);}
"inout" {return tt.ktt(93);}
"input" {return tt.ktt(94);}
"insensitive" {return tt.ktt(95);}
"insert" {return tt.ktt(96);}
"initially" {return tt.ktt(97);}
"into" {return tt.ktt(98);}
"is" {return tt.ktt(99);}
"isolation" {return tt.ktt(100);}
"intersect" {return tt.ktt(101);}
"iterate" {return tt.ktt(102);}
"join" {return tt.ktt(103);}
"key" {return tt.ktt(104);}
"language" {return tt.ktt(105);}
"last" {return tt.ktt(106);}
"leading" {return tt.ktt(107);}
"leave" {return tt.ktt(108);}
"left" {return tt.ktt(109);}
"level" {return tt.ktt(110);}
"like" {return tt.ktt(111);}
"local" {return tt.ktt(112);}
"lock" {return tt.ktt(113);}
"long" {return tt.ktt(114);}
"loop" {return tt.ktt(115);}
"match" {return tt.ktt(116);}
"microsecond" {return tt.ktt(117);}
"minute" {return tt.ktt(118);}
"mod" {return tt.ktt(119);}
"mode" {return tt.ktt(120);}
"modifies" {return tt.ktt(121);}
"month" {return tt.ktt(122);}
"national" {return tt.ktt(123);}
"names" {return tt.ktt(124);}
"natural" {return tt.ktt(125);}
"next" {return tt.ktt(126);}
"no" {return tt.ktt(127);}
"not" {return tt.ktt(128);}
"null" {return tt.ktt(129);}
"offset" {return tt.ktt(130);}
"of" {return tt.ktt(131);}
"oj" {return tt.ktt(132);}
"on" {return tt.ktt(133);}
"only" {return tt.ktt(134);}
"open" {return tt.ktt(135);}
"option" {return tt.ktt(136);}
"optionally" {return tt.ktt(137);}
"or" {return tt.ktt(138);}
"order" {return tt.ktt(139);}
"out" {return tt.ktt(140);}
"outer" {return tt.ktt(141);}
"output" {return tt.ktt(142);}
"overlaps" {return tt.ktt(143);}
"partial" {return tt.ktt(144);}
"precision" {return tt.ktt(145);}
"prepare" {return tt.ktt(146);}
"prev" {return tt.ktt(147);}
"primary" {return tt.ktt(148);}
"prior" {return tt.ktt(149);}
"privileges" {return tt.ktt(150);}
"procedure" {return tt.ktt(151);}
"public" {return tt.ktt(152);}
"query" {return tt.ktt(153);}
"range" {return tt.ktt(154);}
"read" {return tt.ktt(155);}
"reads" {return tt.ktt(156);}
"read_only" {return tt.ktt(157);}
"read_write" {return tt.ktt(158);}
"references" {return tt.ktt(159);}
"release" {return tt.ktt(160);}
"relative" {return tt.ktt(161);}
"rename" {return tt.ktt(162);}
"repeat" {return tt.ktt(163);}
"repeatable" {return tt.ktt(164);}
"restrict" {return tt.ktt(165);}
"return" {return tt.ktt(166);}
"revoke" {return tt.ktt(167);}
"right" {return tt.ktt(168);}
"rollback" {return tt.ktt(169);}
"schema" {return tt.ktt(170);}
"schemas" {return tt.ktt(171);}
"scroll" {return tt.ktt(172);}
"second" {return tt.ktt(173);}
"select" {return tt.ktt(174);}
"sensitive" {return tt.ktt(175);}
"separator" {return tt.ktt(176);}
"serializable" {return tt.ktt(177);}
"session" {return tt.ktt(178);}
"set" {return tt.ktt(179);}
"share" {return tt.ktt(180);}
"show" {return tt.ktt(181);}
"simple" {return tt.ktt(182);}
"size" {return tt.ktt(183);}
"some" {return tt.ktt(184);}
"specific" {return tt.ktt(185);}
"sql" {return tt.ktt(186);}
"sqlexception" {return tt.ktt(187);}
"sqlstate" {return tt.ktt(188);}
"sqlwarning" {return tt.ktt(189);}
"starting" {return tt.ktt(190);}
"table" {return tt.ktt(191);}
"time" {return tt.ktt(192);}
"then" {return tt.ktt(193);}
"to" {return tt.ktt(194);}
"trailing" {return tt.ktt(195);}
"transaction" {return tt.ktt(196);}
"trigger" {return tt.ktt(197);}
"true" {return tt.ktt(198);}
"truncate" {return tt.ktt(199);}
"undo" {return tt.ktt(200);}
"union" {return tt.ktt(201);}
"unique" {return tt.ktt(202);}
"uncommitted" {return tt.ktt(203);}
"unknown" {return tt.ktt(204);}
"update" {return tt.ktt(205);}
"usage" {return tt.ktt(206);}
"using" {return tt.ktt(207);}
"value" {return tt.ktt(208);}
"values" {return tt.ktt(209);}
"varcharacter" {return tt.ktt(210);}
"varying" {return tt.ktt(211);}
"view" {return tt.ktt(212);}
"when" {return tt.ktt(213);}
"where" {return tt.ktt(214);}
"while" {return tt.ktt(215);}
"with" {return tt.ktt(216);}
"without" {return tt.ktt(217);}
"work" {return tt.ktt(218);}
"write" {return tt.ktt(219);}
"year" {return tt.ktt(220);}
"zone" {return tt.ktt(221);}
// MARKER_END_KEYWORDS
