...
"cast" {return tt.ktt(16);}
"change" {return tt.ktt(17);}
...
"cursor" {return tt.ktt(30);}
"data" {return tt.ktt(31);}
"database" {return tt.ktt(32);}
"databases" {return tt.ktt(33);}
"day" {return tt.ktt(34);}
...
"hour" {return tt.ktt(76);}
"if" {return tt.ktt(77);}
"ignore" {return tt.ktt(78);}
"in" {return tt.ktt(79);}
"index" {return tt.ktt(80);}
"indicator" {return tt.ktt(81);}
"infile" {return tt.ktt(82);}
"inner" {return tt.ktt(83);}
"inout" {return tt.ktt(84);}
"insensitive" {return tt.ktt(85);}
"insert" {return tt.ktt(86);}
"int1" {return tt.ktt(87);}
"int2" {return tt.ktt(88);}
"int3" {return tt.ktt(89);}
"int4" {return tt.ktt(90);}
"int8" {return tt.ktt(91);}
...
"minute" {return tt.ktt(120);}
"mod" {return tt.ktt(121);}
"mode" {return tt.ktt(122);}
"modifies" {return tt.ktt(123);}
"month" {return tt.ktt(124);}
"national" {return tt.ktt(125);}
"natural" {return tt.ktt(126);}
"next" {return tt.ktt(127);}
"not" {return tt.ktt(128);}
"no_write_to_binlog" {return tt.ktt(129);}
"null" {return tt.ktt(130);}
"offset" {return tt.ktt(131);}
"oj" {return tt.ktt(132);}
"on" {return tt.ktt(133);}
"open" {return tt.ktt(134);}
"optimize" {return tt.ktt(135);}
...
"outfile" {return tt.ktt(142);}
"precision" {return tt.ktt(143);}
"prev" {return tt.ktt(144);}
"primary" {return tt.ktt(145);}
"procedure" {return tt.ktt(146);}
"purge" {return tt.ktt(147);}
"query" {return tt.ktt(148);}
"quick" {return tt.ktt(149);}
"range" {return tt.ktt(150);}
"read" {return tt.ktt(151);}
"reads" {return tt.ktt(152);}
"read_only" {return tt.ktt(153);}
"read_write" {return tt.ktt(154);}
"references" {return tt.ktt(155);}
"regexp" {return tt.ktt(156);}
"release" {return tt.ktt(157);}
"rename" {return tt.ktt(158);}
"repeat" {return tt.ktt(159);}
"replace" {return tt.ktt(160);}
"require" {return tt.ktt(161);}
"restrict" {return tt.ktt(162);}
"return" {return tt.ktt(163);}
"reverse" {return tt.ktt(164);}
"revoke" {return tt.ktt(165);}
"right" {return tt.ktt(166);}
"rlike" {return tt.ktt(167);}
"rollup" {return tt.ktt(168);}
"schema" {return tt.ktt(169);}
"schemas" {return tt.ktt(170);}
"second" {return tt.ktt(171);}
"select" {return tt.ktt(172);}
"sensitive" {return tt.ktt(173);}
"separator" {return tt.ktt(174);}
"set" {return tt.ktt(175);}
"share" {return tt.ktt(176);}
"show" {return tt.ktt(177);}
"spatial" {return tt.ktt(178);}
"specific" {return tt.ktt(179);}
"sql" {return tt.ktt(180);}
"sqlexception" {return tt.ktt(181);}
"sqlstate" {return tt.ktt(182);}
"sqlwarning" {return tt.ktt(183);}
"sql_big_result" {return tt.ktt(184);}
"sql_buffer_result" {return tt.ktt(185);}
"sql_cache" {return tt.ktt(186);}
"sql_calc_found_rows" {return tt.ktt(187);}
"sql_no_cache" {return tt.ktt(188);}
"sql_small_result" {return tt.ktt(189);}
"ssl" {return tt.ktt(190);}
"starting" {return tt.ktt(191);}
"straight_join" {return tt.ktt(192);}
"table" {return tt.ktt(193);}
"terminated" {return tt.ktt(194);}
"then" {return tt.ktt(195);}
"to" {return tt.ktt(196);}
"trailing" {return tt.ktt(197);}
"trigger" {return tt.ktt(198);}
"true" {return tt.ktt(199);}
"truncate" {return tt.ktt(200);}
"undo" {return tt.ktt(201);}
"union" {return tt.ktt(202);}
"unique" {return tt.ktt(203);}
"unlock" {return tt.ktt(204);}
"unsigned" {return tt.ktt(205);}
"update" {return tt.ktt(206);}
"usage" {return tt.ktt(207);}
"use" {return tt.ktt(208);}
"using" {return tt.ktt(209);}
"value" {return tt.ktt(210);}
"values" {return tt.ktt(211);}
"varcharacter" {return tt.ktt(212);}
"varying" {return tt.ktt(213);}
"when" {return tt.ktt(214);}
"where" {return tt.ktt(215);}
"while" {return tt.ktt(216);}
"with" {return tt.ktt(217);}
"without" {return tt.ktt(218);}
"write" {return tt.ktt(219);}
"xor" {return tt.ktt(220);}
"zerofill" {return tt.ktt(221);}
"zone" {return tt.ktt(222);}
// MARKER_END_KEYWORDS
