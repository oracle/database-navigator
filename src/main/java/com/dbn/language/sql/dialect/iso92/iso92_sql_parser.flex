...
"timezone_hour" {return tt.ktt(212);}
"timezone_minute" {return tt.ktt(213);}
"to" {return tt.ktt(214);}
"trailing" {return tt.ktt(215);}
"transaction" {return tt.ktt(216);}
"translate" {return tt.ktt(217);}
"translation" {return tt.ktt(218);}
"trigger" {return tt.ktt(219);}
"true" {return tt.ktt(220);}
"truncate" {return tt.ktt(221);}
"type" {return tt.ktt(222);}
"undo" {return tt.ktt(223);}
"union" {return tt.ktt(224);}
"unique" {return tt.ktt(225);}
"uncommitted" {return tt.ktt(226);}
"unknown" {return tt.ktt(227);}
"unnamed" {return tt.ktt(228);}
"update" {return tt.ktt(229);}
"usage" {return tt.ktt(230);}
"using" {return tt.ktt(231);}
"value" {return tt.ktt(232);}
"values" {return tt.ktt(233);}
"varcharacter" {return tt.ktt(234);}
"varying" {return tt.ktt(235);}
"view" {return tt.ktt(236);}
"when" {return tt.ktt(237);}
"where" {return tt.ktt(238);}
"while" {return tt.ktt(239);}
"with" {return tt.ktt(240);}
"without" {return tt.ktt(241);}
"work" {return tt.ktt(242);}
"write" {return tt.ktt(243);}
"year" {return tt.ktt(244);}
"zone" {return tt.ktt(245);}
// MARKER_END_KEYWORDS
