...
"assertion" {return tt.ktt(12);}
"asensitive" {return tt.ktt(13);}
"authorization" {return tt.ktt(14);}
"before" {return tt.ktt(15);}
"between" {return tt.ktt(16);}
"both" {return tt.ktt(17);}
"by" {return tt.ktt(18);}
"call" {return tt.ktt(19);}
"cascade" {return tt.ktt(20);}
"cascaded" {return tt.ktt(21);}
"case" {return tt.ktt(22);}
"catalog" {return tt.ktt(23);}
"cast" {return tt.ktt(24);}
"change" {return tt.ktt(25);}
"characteristics" {return tt.ktt(26);}
"check" {return tt.ktt(27);}
"close" {return tt.ktt(28);}
"collate" {return tt.ktt(29);}
"column" {return tt.ktt(30);}
"columns" {return tt.ktt(31);}
"commit" {return tt.ktt(32);}
"committed" {return tt.ktt(33);}
"concurrent" {return tt.ktt(34);}
"connect" {return tt.ktt(35);}
"connection" {return tt.ktt(36);}
"condition" {return tt.ktt(37);}
"constraint" {return tt.ktt(38);}
"constraints" {return tt.ktt(39);}
"continue" {return tt.ktt(40);}
"convert" {return tt.ktt(41);}
"corresponding" {return tt.ktt(42);}
"create" {return tt.ktt(43);}
"cross" {return tt.ktt(44);}
"current" {return tt.ktt(45);}
"cursor" {return tt.ktt(46);}
"data" {return tt.ktt(47);}
"database" {return tt.ktt(48);}
"databases" {return tt.ktt(49);}
"day" {return tt.ktt(50);}
"declare" {return tt.ktt(51);}
"default" {return tt.ktt(52);}
"deferrable" {return tt.ktt(53);}
"deferred" {return tt.ktt(54);}
"deallocate" {return tt.ktt(55);}
"delayed" {return tt.ktt(56);}
"delete" {return tt.ktt(57);}
"desc" {return tt.ktt(58);}
"describe" {return tt.ktt(59);}
"descriptor" {return tt.ktt(60);}
"deterministic" {return tt.ktt(61);}
"diagnostics" {return tt.ktt(62);}
"distinct" {return tt.ktt(63);}
"distinctrow" {return tt.ktt(64);}
"div" {return tt.ktt(65);}
"do" {return tt.ktt(66);}
"domain" {return tt.ktt(67);}
"drop" {return tt.ktt(68);}
"dual" {return tt.ktt(69);}
"dumpfile" {return tt.ktt(70);}
"duplicate" {return tt.ktt(71);}
"each" {return tt.ktt(72);}
"else" {return tt.ktt(73);}
"elseif" {return tt.ktt(74);}
"enclosed" {return tt.ktt(75);}
"end" {return tt.ktt(76);}
"escape" {return tt.ktt(77);}
"escaped" {return tt.ktt(78);}
"except" {return tt.ktt(79);}
"execute" {return tt.ktt(80);}
"exists" {return tt.ktt(81);}
"exit" {return tt.ktt(82);}
"expansion" {return tt.ktt(83);}
"explain" {return tt.ktt(84);}
"false" {return tt.ktt(85);}
"fetch" {return tt.ktt(86);}
"fields" {return tt.ktt(87);}
"first" {return tt.ktt(88);}
"float4" {return tt.ktt(89);}
"float8" {return tt.ktt(90);}
"for" {return tt.ktt(91);}
"force" {return tt.ktt(92);}
"foreign" {return tt.ktt(93);}
"from" {return tt.ktt(94);}
"full" {return tt.ktt(95);}
"fulltext" {return tt.ktt(96);}
"get" {return tt.ktt(97);}
"global" {return tt.ktt(98);}
"grant" {return tt.ktt(99);}
"group" {return tt.ktt(100);}
"handler" {return tt.ktt(101);}
"having" {return tt.ktt(102);}
"high_priority" {return tt.ktt(103);}
"hold" {return tt.ktt(104);}
"hour" {return tt.ktt(105);}
"if" {return tt.ktt(106);}
"ignore" {return tt.ktt(107);}
"immediate" {return tt.ktt(108);}
"in" {return tt.ktt(109);}
"index" {return tt.ktt(110);}
"indicator" {return tt.ktt(111);}
"infile" {return tt.ktt(112);}
"inner" {return tt.ktt(113);}
"inout" {return tt.ktt(114);}
"input" {return tt.ktt(115);}
"insensitive" {return tt.ktt(116);}
"insert" {return tt.ktt(117);}
"int1" {return tt.ktt(118);}
"int2" {return tt.ktt(119);}
"int3" {return tt.ktt(120);}
"int4" {return tt.ktt(121);}
"int8" {return tt.ktt(122);}
"into" {return tt.ktt(123);}
"is" {return tt.ktt(124);}
"isolation" {return tt.ktt(125);}
"intersect" {return tt.ktt(126);}
"iterate" {return tt.ktt(127);}
"join" {return tt.ktt(128);}
"key" {return tt.ktt(129);}
"keys" {return tt.ktt(130);}
"kill" {return tt.ktt(131);}
"language" {return tt.ktt(132);}
"last" {return tt.ktt(133);}
"leading" {return tt.ktt(134);}
"leave" {return tt.ktt(135);}
"left" {return tt.ktt(136);}
"level" {return tt.ktt(137);}
"like" {return tt.ktt(138);}
"limit" {return tt.ktt(139);}
"linear" {return tt.ktt(140);}
"lines" {return tt.ktt(141);}
"load" {return tt.ktt(142);}
"local" {return tt.ktt(143);}
"lock" {return tt.ktt(144);}
"long" {return tt.ktt(145);}
"loop" {return tt.ktt(146);}
"low_ignore" {return tt.ktt(147);}
"low_priority" {return tt.ktt(148);}
"master_ssl_verify_server_cert" {return tt.ktt(149);}
"match" {return tt.ktt(150);}
"microsecond" {return tt.ktt(151);}
"middleint" {return tt.ktt(152);}
"minute" {return tt.ktt(153);}
"mod" {return tt.ktt(154);}
"mode" {return tt.ktt(155);}
"modifies" {return tt.ktt(156);}
"month" {return tt.ktt(157);}
"national" {return tt.ktt(158);}
"names" {return tt.ktt(159);}
"natural" {return tt.ktt(160);}
"next" {return tt.ktt(161);}
"no" {return tt.ktt(162);}
"not" {return tt.ktt(163);}
"no_write_to_binlog" {return tt.ktt(164);}
"null" {return tt.ktt(165);}
"offset" {return tt.ktt(166);}
"of" {return tt.ktt(167);}
"oj" {return tt.ktt(168);}
"on" {return tt.ktt(169);}
"only" {return tt.ktt(170);}
"open" {return tt.ktt(171);}
"optimize" {return tt.ktt(172);}
"option" {return tt.ktt(173);}
"optionally" {return tt.ktt(174);}
"or" {return tt.ktt(175);}
"order" {return tt.ktt(176);}
"out" {return tt.ktt(177);}
"outer" {return tt.ktt(178);}
"output" {return tt.ktt(179);}
"outfile" {return tt.ktt(180);}
"overlaps" {return tt.ktt(181);}
"partial" {return tt.ktt(182);}
"precision" {return tt.ktt(183);}
"prepare" {return tt.ktt(184);}
"prev" {return tt.ktt(185);}
"primary" {return tt.ktt(186);}
"prior" {return tt.ktt(187);}
"privileges" {return tt.ktt(188);}
"procedure" {return tt.ktt(189);}
"public" {return tt.ktt(190);}
"purge" {return tt.ktt(191);}
"query" {return tt.ktt(192);}
"quick" {return tt.ktt(193);}
"range" {return tt.ktt(194);}
"read" {return tt.ktt(195);}
"reads" {return tt.ktt(196);}
"read_only" {return tt.ktt(197);}
"read_write" {return tt.ktt(198);}
"references" {return tt.ktt(199);}
"regexp" {return tt.ktt(200);}
"release" {return tt.ktt(201);}
"relative" {return tt.ktt(202);}
"rename" {return tt.ktt(203);}
"repeat" {return tt.ktt(204);}
"repeatable" {return tt.ktt(205);}
"replace" {return tt.ktt(206);}
"require" {return tt.ktt(207);}
"restrict" {return tt.ktt(208);}
"return" {return tt.ktt(209);}
"reverse" {return tt.ktt(210);}
"revoke" {return tt.ktt(211);}
"right" {return tt.ktt(212);}
"rlike" {return tt.ktt(213);}
"rollback" {return tt.ktt(214);}
"rollup" {return tt.ktt(215);}
"schema" {return tt.ktt(216);}
"schemas" {return tt.ktt(217);}
"scroll" {return tt.ktt(218);}
"second" {return tt.ktt(219);}
"select" {return tt.ktt(220);}
"sensitive" {return tt.ktt(221);}
"separator" {return tt.ktt(222);}
"serializable" {return tt.ktt(223);}
"session" {return tt.ktt(224);}
"set" {return tt.ktt(225);}
"share" {return tt.ktt(226);}
"show" {return tt.ktt(227);}
"simple" {return tt.ktt(228);}
"size" {return tt.ktt(229);}
"some" {return tt.ktt(230);}
"spatial" {return tt.ktt(231);}
"specific" {return tt.ktt(232);}
"sql" {return tt.ktt(233);}
"sqlexception" {return tt.ktt(234);}
"sqlstate" {return tt.ktt(235);}
"sqlwarning" {return tt.ktt(236);}
"sql_big_result" {return tt.ktt(237);}
"sql_buffer_result" {return tt.ktt(238);}
"sql_cache" {return tt.ktt(239);}
"sql_calc_found_rows" {return tt.ktt(240);}
"sql_no_cache" {return tt.ktt(241);}
"sql_small_result" {return tt.ktt(242);}
"ssl" {return tt.ktt(243);}
"starting" {return tt.ktt(244);}
"straight_join" {return tt.ktt(245);}
"table" {return tt.ktt(246);}
"time" {return tt.ktt(247);}
"terminated" {return tt.ktt(248);}
"then" {return tt.ktt(249);}
"to" {return tt.ktt(250);}
"trailing" {return tt.ktt(251);}
"transaction" {return tt.ktt(252);}
"trigger" {return tt.ktt(253);}
"true" {return tt.ktt(254);}
"truncate" {return tt.ktt(255);}
"undo" {return tt.ktt(256);}
"union" {return tt.ktt(257);}
"unique" {return tt.ktt(258);}
"uncommitted" {return tt.ktt(259);}
"unknown" {return tt.ktt(260);}
"unlock" {return tt.ktt(261);}
"unsigned" {return tt.ktt(262);}
"update" {return tt.ktt(263);}
"usage" {return tt.ktt(264);}
"use" {return tt.ktt(265);}
"using" {return tt.ktt(266);}
"value" {return tt.ktt(267);}
"values" {return tt.ktt(268);}
"varcharacter" {return tt.ktt(269);}
"varying" {return tt.ktt(270);}
"view" {return tt.ktt(271);}
"when" {return tt.ktt(272);}
"where" {return tt.ktt(273);}
"while" {return tt.ktt(274);}
"with" {return tt.ktt(275);}
"without" {return tt.ktt(276);}
"work" {return tt.ktt(277);}
"write" {return tt.ktt(278);}
"xor" {return tt.ktt(279);}
"zerofill" {return tt.ktt(280);}
"zone" {return tt.ktt(281);}
// MARKER_END_KEYWORDS
