...
"stored" {return tt.ktt(120);}
"table" {return tt.ktt(121);}
"temp" {return tt.ktt(122);}
"temporary" {return tt.ktt(123);}
"then" {return tt.ktt(124);}
"ties" {return tt.ktt(125);}
"to" {return tt.ktt(126);}
"transaction" {return tt.ktt(127);}
"trigger" {return tt.ktt(128);}
"union" {return tt.ktt(129);}
"unique" {return tt.ktt(130);}
"unbounded" {return tt.ktt(131);}
"update" {return tt.ktt(132);}
"using" {return tt.ktt(133);}
"vacuum" {return tt.ktt(134);}
"values" {return tt.ktt(135);}
"window" {return tt.ktt(136);}
"view" {return tt.ktt(137);}
"virtual" {return tt.ktt(138);}
"when" {return tt.ktt(139);}
"where" {return tt.ktt(140);}
"with" {return tt.ktt(141);}
"without" {return tt.ktt(142);}
// MARKER_END_KEYWORDS
