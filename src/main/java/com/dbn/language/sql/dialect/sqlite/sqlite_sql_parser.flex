...
"do" {return tt.ktt(40);}
"drop" {return tt.ktt(41);}
"exclude" {return tt.ktt(42);}
"each" {return tt.ktt(43);}
"else" {return tt.ktt(44);}
"end" {return tt.ktt(45);}
"escape" {return tt.ktt(46);}
"except" {return tt.ktt(47);}
"exclusive" {return tt.ktt(48);}
"exists" {return tt.ktt(49);}
"explain" {return tt.ktt(50);}
"expressions" {return tt.ktt(51);}
"fail" {return tt.ktt(52);}
"file" {return tt.ktt(53);}
"false" {return tt.ktt(54);}
"fast" {return tt.ktt(55);}
"first" {return tt.ktt(56);}
"filter" {return tt.ktt(57);}
"for" {return tt.ktt(58);}
"foreign" {return tt.ktt(59);}
"following" {return tt.ktt(60);}
"from" {return tt.ktt(61);}
"full" {return tt.ktt(62);}
"last" {return tt.ktt(63);}
"generated" {return tt.ktt(64);}
"glob" {return tt.ktt(65);}
"group" {return tt.ktt(66);}
"groups" {return tt.ktt(67);}
"having" {return tt.ktt(68);}
"if" {return tt.ktt(69);}
"ignore" {return tt.ktt(70);}
"immediate" {return tt.ktt(71);}
"in" {return tt.ktt(72);}
"index" {return tt.ktt(73);}
"indexed" {return tt.ktt(74);}
"initially" {return tt.ktt(75);}
"inner" {return tt.ktt(76);}
"incremental" {return tt.ktt(77);}
"insert" {return tt.ktt(78);}
"instead" {return tt.ktt(79);}
"intersect" {return tt.ktt(80);}
"into" {return tt.ktt(81);}
"is" {return tt.ktt(82);}
"isnull" {return tt.ktt(83);}
"join" {return tt.ktt(84);}
"key" {return tt.ktt(85);}
"left" {return tt.ktt(86);}
"like" {return tt.ktt(87);}
"limit" {return tt.ktt(88);}
"match" {return tt.ktt(89);}
"materialized" {return tt.ktt(90);}
"memory" {return tt.ktt(91);}
"natural" {return tt.ktt(92);}
"n" {return tt.ktt(93);}
"no" {return tt.ktt(94);}
"none" {return tt.ktt(95);}
"not" {return tt.ktt(96);}
"nothing" {return tt.ktt(97);}
"notnull" {return tt.ktt(98);}
"normal" {return tt.ktt(99);}
"null" {return tt.ktt(100);}
"nulls" {return tt.ktt(101);}
"of" {return tt.ktt(102);}
"off" {return tt.ktt(103);}
"offset" {return tt.ktt(104);}
"on" {return tt.ktt(105);}
"or" {return tt.ktt(106);}
"order" {return tt.ktt(107);}
"others" {return tt.ktt(108);}
"outer" {return tt.ktt(109);}
"over" {return tt.ktt(110);}
"passive" {return tt.ktt(111);}
"persist" {return tt.ktt(112);}
"partition" {return tt.ktt(113);}
"plan" {return tt.ktt(114);}
"pragma" {return tt.ktt(115);}
"preceding" {return tt.ktt(116);}
"primary" {return tt.ktt(117);}
"query" {return tt.ktt(118);}
"raise" {return tt.ktt(119);}
"recursive" {return tt.ktt(120);}
"references" {return tt.ktt(121);}
"range" {return tt.ktt(122);}
"regexp" {return tt.ktt(123);}
"reindex" {return tt.ktt(124);}
"release" {return tt.ktt(125);}
"rename" {return tt.ktt(126);}
"replace" {return tt.ktt(127);}
"restrict" {return tt.ktt(128);}
"restart" {return tt.ktt(129);}
"returning" {return tt.ktt(130);}
"right" {return tt.ktt(131);}
"rollback" {return tt.ktt(132);}
"rows" {return tt.ktt(133);}
"row" {return tt.ktt(134);}
"rowid" {return tt.ktt(135);}
"savepoint" {return tt.ktt(136);}
"select" {return tt.ktt(137);}
"set" {return tt.ktt(138);}
"strict" {return tt.ktt(139);}
"stored" {return tt.ktt(140);}
"table" {return tt.ktt(141);}
"temp" {return tt.ktt(142);}
"temporary" {return tt.ktt(143);}
"then" {return tt.ktt(144);}
"ties" {return tt.ktt(145);}
"to" {return tt.ktt(146);}
"transaction" {return tt.ktt(147);}
"trigger" {return tt.ktt(148);}
"true" {return tt.ktt(149);}
"truncate" {return tt.ktt(150);}
"union" {return tt.ktt(151);}
"unique" {return tt.ktt(152);}
"unbounded" {return tt.ktt(153);}
"update" {return tt.ktt(154);}
"using" {return tt.ktt(155);}
"vacuum" {return tt.ktt(156);}
"values" {return tt.ktt(157);}
"window" {return tt.ktt(158);}
"view" {return tt.ktt(159);}
"virtual" {return tt.ktt(160);}
"wal" {return tt.ktt(161);}
"when" {return tt.ktt(162);}
"where" {return tt.ktt(163);}
"with" {return tt.ktt(164);}
"without" {return tt.ktt(165);}
"yes" {return tt.ktt(166);}
// MARKER_END_KEYWORDS
...
"analysis_limit" {return tt.ptt(0);}
"application_id" {return tt.ptt(1);}
"automatic_index" {return tt.ptt(2);}
"auto_vacuum" {return tt.ptt(3);}
"busy_timeout" {return tt.ptt(4);}
"cache_size" {return tt.ptt(5);}
"cache_spill" {return tt.ptt(6);}
"case_sensitive_like" {return tt.ptt(7);}
"cell_size_check" {return tt.ptt(8);}
"checkpoint_fullfsync" {return tt.ptt(9);}
"collation_list" {return tt.ptt(10);}
"compile_options" {return tt.ptt(11);}
"count_changes" {return tt.ptt(12);}
"database_list" {return tt.ptt(13);}
"data_store_directory" {return tt.ptt(14);}
"data_version" {return tt.ptt(15);}
"default_cache_size" {return tt.ptt(16);}
"defer_foreign_keys" {return tt.ptt(17);}
"empty_result_callbacks" {return tt.ptt(18);}
"encoding" {return tt.ptt(19);}
"foreign_keys" {return tt.ptt(20);}
"foreign_key_check" {return tt.ptt(21);}
"foreign_key_list" {return tt.ptt(22);}
"freelist_count" {return tt.ptt(23);}
"fullfsync" {return tt.ptt(24);}
"full_column_names" {return tt.ptt(25);}
"function_list" {return tt.ptt(26);}
"hard_heap_limit" {return tt.ptt(27);}
"ignore_check_constraints" {return tt.ptt(28);}
"incremental_vacuum" {return tt.ptt(29);}
"index_info" {return tt.ptt(30);}
"index_list" {return tt.ptt(31);}
"index_xinfo" {return tt.ptt(32);}
"integrity_check" {return tt.ptt(33);}
"journal_mode" {return tt.ptt(34);}
"journal_size_limit" {return tt.ptt(35);}
"legacy_file_format" {return tt.ptt(36);}
"locking_mode" {return tt.ptt(37);}
"max_page_count" {return tt.ptt(38);}
"mmap_size" {return tt.ptt(39);}
"module_list" {return tt.ptt(40);}
"optimize" {return tt.ptt(41);}
"page_count" {return tt.ptt(42);}
"page_size" {return tt.ptt(43);}
"parser_trace" {return tt.ptt(44);}
"pragma_list" {return tt.ptt(45);}
"query_only" {return tt.ptt(46);}
"quick_check" {return tt.ptt(47);}
"read_uncommitted" {return tt.ptt(48);}
"recursive_triggers" {return tt.ptt(49);}
"reverse_unordered_selects" {return tt.ptt(50);}
"schema_version" {return tt.ptt(51);}
"secure_delete" {return tt.ptt(52);}
"short_column_names" {return tt.ptt(53);}
"shrink_memory" {return tt.ptt(54);}
"soft_heap_limit" {return tt.ptt(55);}
"stats" {return tt.ptt(56);}
"synchronous" {return tt.ptt(57);}
"table_info" {return tt.ptt(58);}
"table_list" {return tt.ptt(59);}
"temp_store" {return tt.ptt(60);}
"temp_store_directory" {return tt.ptt(61);}
"threads" {return tt.ptt(62);}
"trusted_schema" {return tt.ptt(63);}
"user_version" {return tt.ptt(64);}
"vdbe_addoptrace" {return tt.ptt(65);}
"vdbe_debug" {return tt.ptt(66);}
"vdbe_listing" {return tt.ptt(67);}
"vdbe_trace" {return tt.ptt(68);}
"wal_autocheckpoint" {return tt.ptt(69);}
"wal_checkpoint" {return tt.ptt(70);}
"writable_schema" {return tt.ptt(71);}
