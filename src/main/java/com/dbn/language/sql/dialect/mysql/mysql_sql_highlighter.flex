...
SQL_KEYWORD = "accessible"|"account"|"action"|"active"|"admin"|"add"|"after"|"algorithm"|"all"|"alter"|"always"|"analyze"|"and"|"any"|"as"|"asc"|"asensitive"|"at"|"attribute"|"authentication"|"auto"|"backup"|"before"|"begin"|"between"|"binlog"|"block"|"both"|"btree"|"buckets"|"by"|"call"|"cache"|"cascade"|"cascaded"|"cast"|"case"|"change"|"changed"|"filter"|"channel"|"character"|"charset"|"check"|"checksum"|"chain"|"cipher"|"close"|"clone"|"code"|"collate"|"column"|"columns"|"comment"|"commit"|"committed"|"compile"|"compact"|"completion"|"compressed"|"compression"|"concurrent"|"condition"|"connection"|"consistent"|"context"|"constraint"|"contains"|"continue"|"convert"|"copy"|"cpu"|"create"|"cross"|"current"|"current_user"|"cursor"|"data"|"datafile"|"database"|"databases"|"declare"|"default"|"definer"|"definition"|"delayed"|"delete"|"desc"|"describe"|"description"|"deterministic"|"directory"|"disable"|"disk"|"distinct"|"distinctrow"|"div"|"do"|"drop"|"dual"|"duality"|"discard"|"dumpfile"|"duplicate"|"dynamic"|"each"|"else"|"elseif"|"enclosed"|"encryption"|"end"|"enable"|"enforced"|"engine"|"engines"|"ends"|"error"|"errors"|"escape"|"escaped"|"event"|"events"|"every"|"except"|"exchange"|"execute"|"export"|"exists"|"exit"|"exclusive"|"expire"|"expansion"|"explain"|"extended"|"factor"|"faults"|"fast"|"false"|"fetch"|"fields"|"finish"|"first"|"fixed"|"flush"|"following"|"follows"|"for"|"force"|"foreign"|"from"|"full"|"fulltext"|"function"|"generated"|"general"|"generate"|"gtids"|"grant"|"grants"|"global"|"group"|"groups"|"group_replication"|"handler"|"help"|"hash"|"having"|"high_priority"|"histogram"|"history"|"hosts"|"if"|"ignore"|"import"|"identified"|"in"|"index"|"indexes"|"infile"|"inactive"|"initial"|"initiate"|"inner"|"inplace"|"instant"|"inout"|"io_thread"|"innodb"|"insensitive"|"insert"|"intersect"|"interval"|"into"|"invisible"|"instance"|"invoker"|"io"|"ipc"|"is"|"isolation"|"issuer"|"iterate"|"javascript"|"join"|"key"|"keyring"|"keys"|"kill"|"language"|"last"|"leading"|"leave"|"leaves"|"left"|"less"|"level"|"library"|"like"|"limit"|"linear"|"lines"|"list"|"load"|"local"|"logfile"|"logs"|"locked"|"lock"|"loop"|"master"|"manual"|"masking"|"match"|"materialized"|"maxvalue"|"member"|"medium"|"memory"|"merge"|"microsecond"|"migrate"|"mod"|"mode"|"modify"|"modifies"|"mutex"|"national"|"natural"|"name"|"names"|"never"|"new"|"next"|"no"|"none"|"not"|"nowait"|"null"|"offset"|"of"|"oj"|"old"|"on"|"open"|"optimize"|"optimizer_costs"|"option"|"options"|"optional"|"optionally"|"only"|"one"|"organization"|"or"|"order"|"out"|"outer"|"outfile"|"off"|"owner"|"over"|"parser"|"partial"|"partition"|"partitioning"|"partitions"|"password"|"page"|"parse_tree"|"phase"|"plugins"|"policy"|"precision"|"preceding"|"precedes"|"preserve"|"persist"|"persist_only"|"prev"|"prepare"|"primary"|"privileges"|"procedure"|"processlist"|"profile"|"profiles"|"proxy"|"purge"|"query"|"quick"|"random"|"range"|"read"|"reads"|"read_only"|"read_write"|"rebuild"|"recover"|"recursive"|"relay"|"redundant"|"redo_log"|"reference"|"references"|"regexp"|"relational"|"release"|"reload"|"rename"|"repeat"|"repeatable"|"replace"|"registration"|"relaylog"|"require"|"reset"|"restart"|"resume"|"restrict"|"retain"|"return"|"returns"|"reverse"|"replica"|"replicas"|"replication"|"resource"|"remove"|"reorganize"|"repair"|"reuse"|"revoke"|"right"|"rotate"|"rlike"|"rollback"|"rollup"|"role"|"row"|"rows"|"savepoint"|"schedule"|"schema"|"schemas"|"security"|"select"|"sensitive"|"separator"|"serializable"|"server"|"set"|"session"|"share"|"shared"|"shutdown"|"show"|"signed"|"simple"|"skip"|"slave"|"slow"|"snapshot"|"sounds"|"source"|"spatial"|"specific"|"sql"|"sqlexception"|"sqlstate"|"sqlwarning"|"sql_big_result"|"sql_buffer_result"|"sql_cache"|"sql_calc_found_rows"|"sql_no_cache"|"sql_small_result"|"sql_thread"|"ssl"|"start"|"starting"|"starts"|"status"|"stop"|"storage"|"stored"|"straight_join"|"stream"|"subject"|"subpartition"|"subpartitions"|"suspend"|"swaps"|"switches"|"system"|"type"|"until"|"table"|"tables"|"tablespace"|"temporary"|"temptable"|"terminated"|"traditional"|"tree"|"than"|"then"|"tls"|"to"|"trailing"|"transaction"|"trigger"|"triggers"|"true"|"truncate"|"undefined"|"undo"|"undofile"|"union"|"unique"|"unknown"|"unlock"|"unbounded"|"uncommitted"|"unregister"|"unsigned"|"update"|"upgrade"|"usage"|"user_resources"|"use"|"use_frm"|"using"|"validation"|"value"|"values"|"varcharacter"|"variables"|"view"|"virtual"|"visible"|"wait"|"warnings"|"wasm"|"when"|"where"|"while"|"window"|"with"|"without"|"work"|"wrapper"|"write"|"x509"|"xml"|"xa"|"xid"|"xor"|"zerofill"
...
SQL_DATATYPE = "bigint"|"binary"|"bit"|"blob"|"bool"|"boolean"|"char"|"date"|"datetime"|"dec"|"decimal"|"double"|"enum"|"float"|"float4"|"float8"|"geometry"|"geometrycollection"|"int"|"int1"|"int2"|"int3"|"int4"|"int8"|"integer"|"json"|"linestring"|"long"|"longblob"|"longtext"|"mediumblob"|"mediumint"|"middleint"|"mediumtext"|"multilinestring"|"multipoint"|"multipolygon"|"numeric"|"point"|"polygon"|"real"|"smallint"|"text"|"time"|"timestamp"|"tinyblob"|"tinyint"|"tinytext"|"varbinary"|"varchar"|"varying"|"year"
