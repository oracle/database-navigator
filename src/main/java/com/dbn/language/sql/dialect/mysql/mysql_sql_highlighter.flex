...
SQL_KEYWORD = "accessible"|"account"|"action"|"active"|"add"|"after"|"algorithm"|"all"|"alter"|"always"|"analyze"|"and"|"any"|"as"|"asc"|"asensitive"|"at"|"attribute"|"authentication"|"before"|"begin"|"between"|"binlog"|"both"|"btree"|"by"|"call"|"cascade"|"cascaded"|"cast"|"case"|"change"|"channel"|"character"|"charset"|"check"|"checksum"|"cipher"|"close"|"collate"|"column"|"columns"|"comment"|"compile"|"compact"|"completion"|"compressed"|"compression"|"concurrent"|"condition"|"connection"|"constraint"|"contains"|"continue"|"convert"|"copy"|"create"|"cross"|"current"|"current_user"|"cursor"|"data"|"datafile"|"database"|"databases"|"declare"|"default"|"definer"|"delayed"|"delete"|"desc"|"describe"|"deterministic"|"directory"|"disable"|"disk"|"distinct"|"distinctrow"|"div"|"do"|"drop"|"dual"|"duality"|"discard"|"dumpfile"|"duplicate"|"dynamic"|"each"|"else"|"elseif"|"enclosed"|"encryption"|"end"|"enable"|"enforced"|"engine"|"ends"|"error"|"escape"|"escaped"|"event"|"every"|"except"|"exchange"|"exists"|"exit"|"exclusive"|"expire"|"expansion"|"explain"|"factor"|"false"|"fetch"|"fields"|"finish"|"first"|"fixed"|"float4"|"float8"|"following"|"follows"|"for"|"force"|"foreign"|"from"|"full"|"fulltext"|"function"|"generated"|"grant"|"group"|"handler"|"hash"|"having"|"high_priority"|"history"|"if"|"ignore"|"import"|"identified"|"in"|"index"|"infile"|"inactive"|"initial"|"initiate"|"inner"|"inplace"|"instant"|"inout"|"innodb"|"insensitive"|"insert"|"intersect"|"int1"|"int2"|"int3"|"int4"|"int8"|"interval"|"into"|"invisible"|"instance"|"invoker"|"is"|"issuer"|"iterate"|"javascript"|"join"|"key"|"keyring"|"keys"|"kill"|"language"|"last"|"leading"|"leave"|"left"|"less"|"level"|"library"|"like"|"limit"|"linear"|"lines"|"list"|"load"|"local"|"logfile"|"locked"|"lock"|"long"|"loop"|"master"|"match"|"materialized"|"maxvalue"|"member"|"memory"|"merge"|"microsecond"|"middleint"|"mod"|"mode"|"modify"|"modifies"|"national"|"natural"|"never"|"new"|"next"|"no"|"none"|"not"|"nowait"|"null"|"offset"|"of"|"oj"|"old"|"on"|"open"|"optimize"|"option"|"options"|"optional"|"optionally"|"only"|"or"|"order"|"out"|"outer"|"outfile"|"off"|"owner"|"over"|"parser"|"partial"|"partition"|"partitioning"|"partitions"|"password"|"precision"|"preceding"|"precedes"|"preserve"|"prev"|"primary"|"procedure"|"purge"|"query"|"quick"|"random"|"range"|"read"|"reads"|"read_only"|"read_write"|"rebuild"|"recursive"|"redundant"|"redo_log"|"references"|"regexp"|"release"|"reload"|"rename"|"repeat"|"replace"|"registration"|"require"|"restrict"|"retain"|"return"|"reverse"|"replica"|"resource"|"remove"|"reorganize"|"repair"|"reuse"|"revoke"|"right"|"rotate"|"rlike"|"rollback"|"rollup"|"role"|"row"|"rows"|"schedule"|"schema"|"schemas"|"security"|"select"|"sensitive"|"separator"|"server"|"set"|"share"|"shared"|"show"|"signed"|"simple"|"skip"|"slave"|"sounds"|"spatial"|"specific"|"sql"|"sqlexception"|"sqlstate"|"sqlwarning"|"sql_big_result"|"sql_buffer_result"|"sql_cache"|"sql_calc_found_rows"|"sql_no_cache"|"sql_small_result"|"ssl"|"start"|"starting"|"starts"|"storage"|"stored"|"straight_join"|"subject"|"subpartition"|"subpartitions"|"table"|"tablespace"|"temporary"|"temptable"|"terminated"|"than"|"then"|"tls"|"to"|"trailing"|"transaction"|"trigger"|"true"|"truncate"|"undefined"|"undo"|"undofile"|"union"|"unique"|"unknown"|"unlock"|"unbounded"|"unregister"|"unsigned"|"update"|"upgrade"|"usage"|"use"|"using"|"validation"|"value"|"values"|"varcharacter"|"varying"|"view"|"virtual"|"visible"|"wait"|"when"|"where"|"while"|"window"|"with"|"without"|"write"|"x509"|"xor"|"zerofill"
...
SQL_PARAMETER = "autoextend_size"|"auto_increment"|"avg_row_length"|"challenge_response"|"column_format"|"delay_key_write"|"engine_attribute"|"failed_login_attempts"|"insert_method"|"initial_size"|"key_block_size"|"low_ignore"|"low_priority"|"master_ssl_verify_server_cert"|"max_connections_per_hour"|"max_rows"|"max_queries_per_hour"|"max_updates_per_hour"|"max_user_connections"|"min_rows"|"no_write_to_binlog"|"pack_keys"|"password_lock_time"|"row_format"|"secondary_engine_attribute"|"stats_auto_recalc"|"stats_persistent"|"stats_sample_pages"|"thread_priority"|"vcpu"
