...
SQL_KEYWORD = "accessible"|"account"|"action"|"add"|"after"|"algorithm"|"all"|"alter"|"always"|"analyze"|"and"|"as"|"asc"|"asensitive"|"at"|"attribute"|"authentication"|"before"|"begin"|"between"|"both"|"btree"|"by"|"call"|"cascade"|"cascaded"|"case"|"change"|"character"|"charset"|"check"|"checksum"|"cipher"|"close"|"collate"|"column"|"columns"|"comment"|"compact"|"completion"|"compressed"|"compression"|"concurrent"|"condition"|"connection"|"constraint"|"continue"|"convert"|"copy"|"create"|"cross"|"current"|"current_user"|"cursor"|"data"|"database"|"databases"|"declare"|"default"|"definer"|"delayed"|"delete"|"desc"|"describe"|"deterministic"|"directory"|"disable"|"disk"|"distinct"|"distinctrow"|"div"|"do"|"drop"|"dual"|"dumpfile"|"duplicate"|"dynamic"|"each"|"else"|"elseif"|"enclosed"|"encryption"|"end"|"enable"|"enforced"|"engine"|"ends"|"escaped"|"event"|"every"|"exists"|"exit"|"exclusive"|"expire"|"expansion"|"explain"|"false"|"fetch"|"fields"|"first"|"fixed"|"float4"|"float8"|"follows"|"for"|"force"|"foreign"|"from"|"full"|"fulltext"|"generated"|"grant"|"group"|"handler"|"hash"|"having"|"high_priority"|"history"|"if"|"ignore"|"identified"|"in"|"index"|"infile"|"initial"|"inner"|"inplace"|"inout"|"insensitive"|"insert"|"int1"|"int2"|"int3"|"int4"|"int8"|"interval"|"into"|"invisible"|"invoker"|"is"|"issuer"|"iterate"|"join"|"key"|"keys"|"kill"|"language"|"last"|"leading"|"leave"|"left"|"less"|"level"|"like"|"limit"|"linear"|"lines"|"list"|"load"|"local"|"lock"|"long"|"loop"|"match"|"maxvalue"|"memory"|"merge"|"microsecond"|"middleint"|"mod"|"mode"|"modifies"|"national"|"natural"|"never"|"new"|"next"|"no"|"none"|"not"|"null"|"offset"|"oj"|"old"|"on"|"open"|"optimize"|"option"|"optional"|"optionally"|"or"|"order"|"out"|"outer"|"outfile"|"parser"|"partial"|"partition"|"partitions"|"password"|"precision"|"precedes"|"preserve"|"prev"|"primary"|"procedure"|"purge"|"query"|"quick"|"random"|"range"|"read"|"reads"|"read_only"|"read_write"|"recursive"|"redundant"|"references"|"regexp"|"release"|"rename"|"repeat"|"replace"|"require"|"restrict"|"return"|"reverse"|"replica"|"reuse"|"revoke"|"right"|"rlike"|"rollback"|"rollup"|"role"|"row"|"schedule"|"schema"|"schemas"|"security"|"select"|"sensitive"|"separator"|"set"|"share"|"shared"|"show"|"simple"|"slave"|"spatial"|"specific"|"sql"|"sqlexception"|"sqlstate"|"sqlwarning"|"sql_big_result"|"sql_buffer_result"|"sql_cache"|"sql_calc_found_rows"|"sql_no_cache"|"sql_small_result"|"ssl"|"start"|"starting"|"starts"|"storage"|"stored"|"straight_join"|"subject"|"subpartition"|"subpartitions"|"table"|"tablespace"|"temporary"|"temptable"|"terminated"|"than"|"then"|"to"|"trailing"|"transaction"|"trigger"|"true"|"truncate"|"undefined"|"undo"|"union"|"unique"|"unlock"|"unbounded"|"unsigned"|"update"|"usage"|"use"|"using"|"value"|"values"|"varcharacter"|"varying"|"view"|"virtual"|"visible"|"when"|"where"|"while"|"with"|"write"|"x509"|"xor"|"zerofill"
