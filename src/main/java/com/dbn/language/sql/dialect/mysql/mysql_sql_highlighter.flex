...
SQL_KEYWORD = "accessible"|"account"|"action"|"active"|"add"|"after"|"algorithm"|"all"|"alter"|"always"|"analyze"|"and"|"any"|"as"|"asc"|"asensitive"|"at"|"attribute"|"authentication"|"backup"|"before"|"begin"|"between"|"binlog"|"both"|"btree"|"by"|"call"|"cascade"|"cascaded"|"cast"|"case"|"change"|"channel"|"character"|"charset"|"check"|"checksum"|"chain"|"cipher"|"close"|"collate"|"column"|"columns"|"comment"|"commit"|"committed"|"compile"|"compact"|"completion"|"compressed"|"compression"|"concurrent"|"condition"|"connection"|"consistent"|"constraint"|"contains"|"continue"|"convert"|"copy"|"create"|"cross"|"current"|"current_user"|"cursor"|"data"|"datafile"|"database"|"databases"|"declare"|"default"|"definer"|"definition"|"delayed"|"delete"|"desc"|"describe"|"description"|"deterministic"|"directory"|"disable"|"disk"|"distinct"|"distinctrow"|"div"|"do"|"drop"|"dual"|"duality"|"discard"|"dumpfile"|"duplicate"|"dynamic"|"each"|"else"|"elseif"|"enclosed"|"encryption"|"end"|"enable"|"enforced"|"engine"|"ends"|"error"|"escape"|"escaped"|"event"|"every"|"except"|"exchange"|"export"|"exists"|"exit"|"exclusive"|"expire"|"expansion"|"explain"|"factor"|"false"|"fetch"|"fields"|"finish"|"first"|"fixed"|"float4"|"float8"|"flush"|"following"|"follows"|"for"|"force"|"foreign"|"from"|"full"|"fulltext"|"function"|"generated"|"general"|"grant"|"global"|"group"|"handler"|"hash"|"having"|"high_priority"|"history"|"if"|"ignore"|"import"|"identified"|"in"|"index"|"infile"|"inactive"|"initial"|"initiate"|"inner"|"inplace"|"instant"|"inout"|"innodb"|"insensitive"|"insert"|"intersect"|"int1"|"int2"|"int3"|"int4"|"int8"|"interval"|"into"|"invisible"|"instance"|"invoker"|"is"|"isolation"|"issuer"|"iterate"|"javascript"|"join"|"key"|"keyring"|"keys"|"kill"|"language"|"last"|"leading"|"leave"|"left"|"less"|"level"|"library"|"like"|"limit"|"linear"|"lines"|"list"|"load"|"local"|"logfile"|"locked"|"lock"|"long"|"loop"|"master"|"masking"|"match"|"materialized"|"maxvalue"|"member"|"memory"|"merge"|"microsecond"|"middleint"|"migrate"|"mod"|"mode"|"modify"|"modifies"|"national"|"natural"|"name"|"never"|"new"|"next"|"no"|"none"|"not"|"nowait"|"null"|"offset"|"of"|"oj"|"old"|"on"|"open"|"optimize"|"option"|"options"|"optional"|"optionally"|"only"|"one"|"organization"|"or"|"order"|"out"|"outer"|"outfile"|"off"|"owner"|"over"|"parser"|"partial"|"partition"|"partitioning"|"partitions"|"password"|"phase"|"policy"|"precision"|"preceding"|"precedes"|"preserve"|"prev"|"prepare"|"primary"|"procedure"|"purge"|"query"|"quick"|"random"|"range"|"read"|"reads"|"read_only"|"read_write"|"rebuild"|"recover"|"recursive"|"redundant"|"redo_log"|"reference"|"references"|"regexp"|"relational"|"release"|"reload"|"rename"|"repeat"|"repeatable"|"replace"|"registration"|"require"|"resume"|"restrict"|"retain"|"return"|"returns"|"reverse"|"replica"|"resource"|"remove"|"reorganize"|"repair"|"reuse"|"revoke"|"right"|"rotate"|"rlike"|"rollback"|"rollup"|"role"|"row"|"rows"|"savepoint"|"schedule"|"schema"|"schemas"|"security"|"select"|"sensitive"|"separator"|"serializable"|"server"|"set"|"session"|"share"|"shared"|"show"|"signed"|"simple"|"skip"|"slave"|"snapshot"|"sounds"|"spatial"|"specific"|"sql"|"sqlexception"|"sqlstate"|"sqlwarning"|"sql_big_result"|"sql_buffer_result"|"sql_cache"|"sql_calc_found_rows"|"sql_no_cache"|"sql_small_result"|"ssl"|"start"|"starting"|"starts"|"storage"|"stored"|"straight_join"|"subject"|"subpartition"|"subpartitions"|"suspend"|"system"|"table"|"tables"|"tablespace"|"temporary"|"temptable"|"terminated"|"than"|"then"|"tls"|"to"|"trailing"|"transaction"|"trigger"|"true"|"truncate"|"undefined"|"undo"|"undofile"|"union"|"unique"|"unknown"|"unlock"|"unbounded"|"uncommitted"|"unregister"|"unsigned"|"update"|"upgrade"|"usage"|"use"|"using"|"validation"|"value"|"values"|"varcharacter"|"varying"|"view"|"virtual"|"visible"|"wait"|"wasm"|"when"|"where"|"while"|"window"|"with"|"without"|"work"|"wrapper"|"write"|"x509"|"xml"|"xa"|"xid"|"xor"|"zerofill"
