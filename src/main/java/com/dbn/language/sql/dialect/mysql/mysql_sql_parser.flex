...
"definition" {return tt.ktt(68);}
"delayed" {return tt.ktt(69);}
"delete" {return tt.ktt(70);}
"desc" {return tt.ktt(71);}
"describe" {return tt.ktt(72);}
"description" {return tt.ktt(73);}
"deterministic" {return tt.ktt(74);}
"directory" {return tt.ktt(75);}
"disable" {return tt.ktt(76);}
"disk" {return tt.ktt(77);}
"distinct" {return tt.ktt(78);}
"distinctrow" {return tt.ktt(79);}
"div" {return tt.ktt(80);}
"do" {return tt.ktt(81);}
"drop" {return tt.ktt(82);}
"dual" {return tt.ktt(83);}
"duality" {return tt.ktt(84);}
"discard" {return tt.ktt(85);}
"dumpfile" {return tt.ktt(86);}
"duplicate" {return tt.ktt(87);}
"dynamic" {return tt.ktt(88);}
"each" {return tt.ktt(89);}
"else" {return tt.ktt(90);}
"elseif" {return tt.ktt(91);}
"enclosed" {return tt.ktt(92);}
"encryption" {return tt.ktt(93);}
"end" {return tt.ktt(94);}
"enable" {return tt.ktt(95);}
"enforced" {return tt.ktt(96);}
"engine" {return tt.ktt(97);}
"ends" {return tt.ktt(98);}
"error" {return tt.ktt(99);}
"escape" {return tt.ktt(100);}
"escaped" {return tt.ktt(101);}
"event" {return tt.ktt(102);}
"every" {return tt.ktt(103);}
"except" {return tt.ktt(104);}
"exchange" {return tt.ktt(105);}
"exists" {return tt.ktt(106);}
"exit" {return tt.ktt(107);}
"exclusive" {return tt.ktt(108);}
"expire" {return tt.ktt(109);}
"expansion" {return tt.ktt(110);}
"explain" {return tt.ktt(111);}
"factor" {return tt.ktt(112);}
"false" {return tt.ktt(113);}
"fetch" {return tt.ktt(114);}
"fields" {return tt.ktt(115);}
"finish" {return tt.ktt(116);}
"first" {return tt.ktt(117);}
"fixed" {return tt.ktt(118);}
"float4" {return tt.ktt(119);}
"float8" {return tt.ktt(120);}
"following" {return tt.ktt(121);}
"follows" {return tt.ktt(122);}
"for" {return tt.ktt(123);}
"force" {return tt.ktt(124);}
"foreign" {return tt.ktt(125);}
"from" {return tt.ktt(126);}
"full" {return tt.ktt(127);}
"fulltext" {return tt.ktt(128);}
"function" {return tt.ktt(129);}
"generated" {return tt.ktt(130);}
"general" {return tt.ktt(131);}
"grant" {return tt.ktt(132);}
"group" {return tt.ktt(133);}
"handler" {return tt.ktt(134);}
"hash" {return tt.ktt(135);}
"having" {return tt.ktt(136);}
"high_priority" {return tt.ktt(137);}
"history" {return tt.ktt(138);}
"if" {return tt.ktt(139);}
"ignore" {return tt.ktt(140);}
"import" {return tt.ktt(141);}
"identified" {return tt.ktt(142);}
"in" {return tt.ktt(143);}
"index" {return tt.ktt(144);}
"infile" {return tt.ktt(145);}
"inactive" {return tt.ktt(146);}
"initial" {return tt.ktt(147);}
"initiate" {return tt.ktt(148);}
"inner" {return tt.ktt(149);}
"inplace" {return tt.ktt(150);}
"instant" {return tt.ktt(151);}
"inout" {return tt.ktt(152);}
"innodb" {return tt.ktt(153);}
"insensitive" {return tt.ktt(154);}
"insert" {return tt.ktt(155);}
"intersect" {return tt.ktt(156);}
"int1" {return tt.ktt(157);}
"int2" {return tt.ktt(158);}
"int3" {return tt.ktt(159);}
"int4" {return tt.ktt(160);}
"int8" {return tt.ktt(161);}
"interval" {return tt.ktt(162);}
"into" {return tt.ktt(163);}
"invisible" {return tt.ktt(164);}
"instance" {return tt.ktt(165);}
"invoker" {return tt.ktt(166);}
"is" {return tt.ktt(167);}
"issuer" {return tt.ktt(168);}
"iterate" {return tt.ktt(169);}
"javascript" {return tt.ktt(170);}
"join" {return tt.ktt(171);}
"key" {return tt.ktt(172);}
"keyring" {return tt.ktt(173);}
"keys" {return tt.ktt(174);}
"kill" {return tt.ktt(175);}
"language" {return tt.ktt(176);}
"last" {return tt.ktt(177);}
"leading" {return tt.ktt(178);}
"leave" {return tt.ktt(179);}
"left" {return tt.ktt(180);}
"less" {return tt.ktt(181);}
"level" {return tt.ktt(182);}
"library" {return tt.ktt(183);}
"like" {return tt.ktt(184);}
"limit" {return tt.ktt(185);}
"linear" {return tt.ktt(186);}
"lines" {return tt.ktt(187);}
"list" {return tt.ktt(188);}
"load" {return tt.ktt(189);}
"local" {return tt.ktt(190);}
"logfile" {return tt.ktt(191);}
"locked" {return tt.ktt(192);}
"lock" {return tt.ktt(193);}
"long" {return tt.ktt(194);}
"loop" {return tt.ktt(195);}
"master" {return tt.ktt(196);}
"masking" {return tt.ktt(197);}
"match" {return tt.ktt(198);}
"materialized" {return tt.ktt(199);}
"maxvalue" {return tt.ktt(200);}
"member" {return tt.ktt(201);}
"memory" {return tt.ktt(202);}
"merge" {return tt.ktt(203);}
"microsecond" {return tt.ktt(204);}
"middleint" {return tt.ktt(205);}
"mod" {return tt.ktt(206);}
"mode" {return tt.ktt(207);}
"modify" {return tt.ktt(208);}
"modifies" {return tt.ktt(209);}
"national" {return tt.ktt(210);}
"natural" {return tt.ktt(211);}
"name" {return tt.ktt(212);}
"never" {return tt.ktt(213);}
"new" {return tt.ktt(214);}
"next" {return tt.ktt(215);}
"no" {return tt.ktt(216);}
"none" {return tt.ktt(217);}
"not" {return tt.ktt(218);}
"nowait" {return tt.ktt(219);}
"null" {return tt.ktt(220);}
"offset" {return tt.ktt(221);}
"of" {return tt.ktt(222);}
"oj" {return tt.ktt(223);}
"old" {return tt.ktt(224);}
"on" {return tt.ktt(225);}
"open" {return tt.ktt(226);}
"optimize" {return tt.ktt(227);}
"option" {return tt.ktt(228);}
"options" {return tt.ktt(229);}
"optional" {return tt.ktt(230);}
"optionally" {return tt.ktt(231);}
"only" {return tt.ktt(232);}
"organization" {return tt.ktt(233);}
"or" {return tt.ktt(234);}
"order" {return tt.ktt(235);}
"out" {return tt.ktt(236);}
"outer" {return tt.ktt(237);}
"outfile" {return tt.ktt(238);}
"off" {return tt.ktt(239);}
"owner" {return tt.ktt(240);}
"over" {return tt.ktt(241);}
"parser" {return tt.ktt(242);}
"partial" {return tt.ktt(243);}
"partition" {return tt.ktt(244);}
"partitioning" {return tt.ktt(245);}
"partitions" {return tt.ktt(246);}
"password" {return tt.ktt(247);}
"policy" {return tt.ktt(248);}
"precision" {return tt.ktt(249);}
"preceding" {return tt.ktt(250);}
"precedes" {return tt.ktt(251);}
"preserve" {return tt.ktt(252);}
"prev" {return tt.ktt(253);}
"primary" {return tt.ktt(254);}
"procedure" {return tt.ktt(255);}
"purge" {return tt.ktt(256);}
"query" {return tt.ktt(257);}
"quick" {return tt.ktt(258);}
"random" {return tt.ktt(259);}
"range" {return tt.ktt(260);}
"read" {return tt.ktt(261);}
"reads" {return tt.ktt(262);}
"read_only" {return tt.ktt(263);}
"read_write" {return tt.ktt(264);}
"rebuild" {return tt.ktt(265);}
"recursive" {return tt.ktt(266);}
"redundant" {return tt.ktt(267);}
"redo_log" {return tt.ktt(268);}
"reference" {return tt.ktt(269);}
"references" {return tt.ktt(270);}
"regexp" {return tt.ktt(271);}
"relational" {return tt.ktt(272);}
"release" {return tt.ktt(273);}
"reload" {return tt.ktt(274);}
"rename" {return tt.ktt(275);}
"repeat" {return tt.ktt(276);}
"replace" {return tt.ktt(277);}
"registration" {return tt.ktt(278);}
"require" {return tt.ktt(279);}
"restrict" {return tt.ktt(280);}
"retain" {return tt.ktt(281);}
"return" {return tt.ktt(282);}
"returns" {return tt.ktt(283);}
"reverse" {return tt.ktt(284);}
"replica" {return tt.ktt(285);}
"resource" {return tt.ktt(286);}
"remove" {return tt.ktt(287);}
"reorganize" {return tt.ktt(288);}
"repair" {return tt.ktt(289);}
"reuse" {return tt.ktt(290);}
"revoke" {return tt.ktt(291);}
"right" {return tt.ktt(292);}
"rotate" {return tt.ktt(293);}
"rlike" {return tt.ktt(294);}
"rollback" {return tt.ktt(295);}
"rollup" {return tt.ktt(296);}
"role" {return tt.ktt(297);}
"row" {return tt.ktt(298);}
"rows" {return tt.ktt(299);}
"schedule" {return tt.ktt(300);}
"schema" {return tt.ktt(301);}
"schemas" {return tt.ktt(302);}
"security" {return tt.ktt(303);}
"select" {return tt.ktt(304);}
"sensitive" {return tt.ktt(305);}
"separator" {return tt.ktt(306);}
"server" {return tt.ktt(307);}
"set" {return tt.ktt(308);}
"share" {return tt.ktt(309);}
"shared" {return tt.ktt(310);}
"show" {return tt.ktt(311);}
"signed" {return tt.ktt(312);}
"simple" {return tt.ktt(313);}
"skip" {return tt.ktt(314);}
"slave" {return tt.ktt(315);}
"sounds" {return tt.ktt(316);}
"spatial" {return tt.ktt(317);}
"specific" {return tt.ktt(318);}
"sql" {return tt.ktt(319);}
"sqlexception" {return tt.ktt(320);}
"sqlstate" {return tt.ktt(321);}
"sqlwarning" {return tt.ktt(322);}
"sql_big_result" {return tt.ktt(323);}
"sql_buffer_result" {return tt.ktt(324);}
"sql_cache" {return tt.ktt(325);}
"sql_calc_found_rows" {return tt.ktt(326);}
"sql_no_cache" {return tt.ktt(327);}
"sql_small_result" {return tt.ktt(328);}
"ssl" {return tt.ktt(329);}
"start" {return tt.ktt(330);}
"starting" {return tt.ktt(331);}
"starts" {return tt.ktt(332);}
"storage" {return tt.ktt(333);}
"stored" {return tt.ktt(334);}
"straight_join" {return tt.ktt(335);}
"subject" {return tt.ktt(336);}
"subpartition" {return tt.ktt(337);}
"subpartitions" {return tt.ktt(338);}
"system" {return tt.ktt(339);}
"table" {return tt.ktt(340);}
"tablespace" {return tt.ktt(341);}
"temporary" {return tt.ktt(342);}
"temptable" {return tt.ktt(343);}
"terminated" {return tt.ktt(344);}
"than" {return tt.ktt(345);}
"then" {return tt.ktt(346);}
"tls" {return tt.ktt(347);}
"to" {return tt.ktt(348);}
"trailing" {return tt.ktt(349);}
"transaction" {return tt.ktt(350);}
"trigger" {return tt.ktt(351);}
"true" {return tt.ktt(352);}
"truncate" {return tt.ktt(353);}
"undefined" {return tt.ktt(354);}
"undo" {return tt.ktt(355);}
"undofile" {return tt.ktt(356);}
"union" {return tt.ktt(357);}
"unique" {return tt.ktt(358);}
"unknown" {return tt.ktt(359);}
"unlock" {return tt.ktt(360);}
"unbounded" {return tt.ktt(361);}
"unregister" {return tt.ktt(362);}
"unsigned" {return tt.ktt(363);}
"update" {return tt.ktt(364);}
"upgrade" {return tt.ktt(365);}
"usage" {return tt.ktt(366);}
"use" {return tt.ktt(367);}
"using" {return tt.ktt(368);}
"validation" {return tt.ktt(369);}
"value" {return tt.ktt(370);}
"values" {return tt.ktt(371);}
"varcharacter" {return tt.ktt(372);}
"varying" {return tt.ktt(373);}
"view" {return tt.ktt(374);}
"virtual" {return tt.ktt(375);}
"visible" {return tt.ktt(376);}
"wait" {return tt.ktt(377);}
"wasm" {return tt.ktt(378);}
"when" {return tt.ktt(379);}
"where" {return tt.ktt(380);}
"while" {return tt.ktt(381);}
"window" {return tt.ktt(382);}
"with" {return tt.ktt(383);}
"without" {return tt.ktt(384);}
