...
"escape" {return tt.ktt(98);}
"escaped" {return tt.ktt(99);}
"event" {return tt.ktt(100);}
"every" {return tt.ktt(101);}
"except" {return tt.ktt(102);}
"exchange" {return tt.ktt(103);}
"exists" {return tt.ktt(104);}
"exit" {return tt.ktt(105);}
"exclusive" {return tt.ktt(106);}
"expire" {return tt.ktt(107);}
"expansion" {return tt.ktt(108);}
"explain" {return tt.ktt(109);}
"factor" {return tt.ktt(110);}
"false" {return tt.ktt(111);}
"fetch" {return tt.ktt(112);}
"fields" {return tt.ktt(113);}
"finish" {return tt.ktt(114);}
"first" {return tt.ktt(115);}
"fixed" {return tt.ktt(116);}
"float4" {return tt.ktt(117);}
"float8" {return tt.ktt(118);}
"following" {return tt.ktt(119);}
"follows" {return tt.ktt(120);}
"for" {return tt.ktt(121);}
"force" {return tt.ktt(122);}
"foreign" {return tt.ktt(123);}
"from" {return tt.ktt(124);}
"full" {return tt.ktt(125);}
"fulltext" {return tt.ktt(126);}
"function" {return tt.ktt(127);}
"generated" {return tt.ktt(128);}
"grant" {return tt.ktt(129);}
"group" {return tt.ktt(130);}
"handler" {return tt.ktt(131);}
"hash" {return tt.ktt(132);}
"having" {return tt.ktt(133);}
"high_priority" {return tt.ktt(134);}
"history" {return tt.ktt(135);}
"if" {return tt.ktt(136);}
"ignore" {return tt.ktt(137);}
"import" {return tt.ktt(138);}
"identified" {return tt.ktt(139);}
"in" {return tt.ktt(140);}
"index" {return tt.ktt(141);}
"infile" {return tt.ktt(142);}
"inactive" {return tt.ktt(143);}
"initial" {return tt.ktt(144);}
"initiate" {return tt.ktt(145);}
"inner" {return tt.ktt(146);}
"inplace" {return tt.ktt(147);}
"instant" {return tt.ktt(148);}
"inout" {return tt.ktt(149);}
"innodb" {return tt.ktt(150);}
"insensitive" {return tt.ktt(151);}
"insert" {return tt.ktt(152);}
"intersect" {return tt.ktt(153);}
"int1" {return tt.ktt(154);}
"int2" {return tt.ktt(155);}
"int3" {return tt.ktt(156);}
"int4" {return tt.ktt(157);}
"int8" {return tt.ktt(158);}
"interval" {return tt.ktt(159);}
"into" {return tt.ktt(160);}
"invisible" {return tt.ktt(161);}
"instance" {return tt.ktt(162);}
"invoker" {return tt.ktt(163);}
"is" {return tt.ktt(164);}
"issuer" {return tt.ktt(165);}
"iterate" {return tt.ktt(166);}
"javascript" {return tt.ktt(167);}
"join" {return tt.ktt(168);}
"key" {return tt.ktt(169);}
"keyring" {return tt.ktt(170);}
"keys" {return tt.ktt(171);}
"kill" {return tt.ktt(172);}
"language" {return tt.ktt(173);}
"last" {return tt.ktt(174);}
"leading" {return tt.ktt(175);}
"leave" {return tt.ktt(176);}
"left" {return tt.ktt(177);}
"less" {return tt.ktt(178);}
"level" {return tt.ktt(179);}
"library" {return tt.ktt(180);}
"like" {return tt.ktt(181);}
"limit" {return tt.ktt(182);}
"linear" {return tt.ktt(183);}
"lines" {return tt.ktt(184);}
"list" {return tt.ktt(185);}
"load" {return tt.ktt(186);}
"local" {return tt.ktt(187);}
"logfile" {return tt.ktt(188);}
"locked" {return tt.ktt(189);}
"lock" {return tt.ktt(190);}
"long" {return tt.ktt(191);}
"loop" {return tt.ktt(192);}
"master" {return tt.ktt(193);}
"match" {return tt.ktt(194);}
"materialized" {return tt.ktt(195);}
"maxvalue" {return tt.ktt(196);}
"member" {return tt.ktt(197);}
"memory" {return tt.ktt(198);}
"merge" {return tt.ktt(199);}
"microsecond" {return tt.ktt(200);}
"middleint" {return tt.ktt(201);}
"mod" {return tt.ktt(202);}
"mode" {return tt.ktt(203);}
"modify" {return tt.ktt(204);}
"modifies" {return tt.ktt(205);}
"national" {return tt.ktt(206);}
"natural" {return tt.ktt(207);}
"never" {return tt.ktt(208);}
"new" {return tt.ktt(209);}
"next" {return tt.ktt(210);}
"no" {return tt.ktt(211);}
"none" {return tt.ktt(212);}
"not" {return tt.ktt(213);}
"nowait" {return tt.ktt(214);}
"null" {return tt.ktt(215);}
"offset" {return tt.ktt(216);}
"of" {return tt.ktt(217);}
"oj" {return tt.ktt(218);}
"old" {return tt.ktt(219);}
"on" {return tt.ktt(220);}
"open" {return tt.ktt(221);}
"optimize" {return tt.ktt(222);}
"option" {return tt.ktt(223);}
"options" {return tt.ktt(224);}
"optional" {return tt.ktt(225);}
"optionally" {return tt.ktt(226);}
"only" {return tt.ktt(227);}
"or" {return tt.ktt(228);}
"order" {return tt.ktt(229);}
"out" {return tt.ktt(230);}
"outer" {return tt.ktt(231);}
"outfile" {return tt.ktt(232);}
"off" {return tt.ktt(233);}
"owner" {return tt.ktt(234);}
"over" {return tt.ktt(235);}
"parser" {return tt.ktt(236);}
"partial" {return tt.ktt(237);}
"partition" {return tt.ktt(238);}
"partitioning" {return tt.ktt(239);}
"partitions" {return tt.ktt(240);}
"password" {return tt.ktt(241);}
"precision" {return tt.ktt(242);}
"preceding" {return tt.ktt(243);}
"precedes" {return tt.ktt(244);}
"preserve" {return tt.ktt(245);}
"prev" {return tt.ktt(246);}
"primary" {return tt.ktt(247);}
"procedure" {return tt.ktt(248);}
"purge" {return tt.ktt(249);}
"query" {return tt.ktt(250);}
"quick" {return tt.ktt(251);}
"random" {return tt.ktt(252);}
"range" {return tt.ktt(253);}
"read" {return tt.ktt(254);}
"reads" {return tt.ktt(255);}
"read_only" {return tt.ktt(256);}
"read_write" {return tt.ktt(257);}
"rebuild" {return tt.ktt(258);}
"recursive" {return tt.ktt(259);}
"redundant" {return tt.ktt(260);}
"redo_log" {return tt.ktt(261);}
"references" {return tt.ktt(262);}
"regexp" {return tt.ktt(263);}
"release" {return tt.ktt(264);}
"reload" {return tt.ktt(265);}
"rename" {return tt.ktt(266);}
"repeat" {return tt.ktt(267);}
"replace" {return tt.ktt(268);}
"registration" {return tt.ktt(269);}
"require" {return tt.ktt(270);}
"restrict" {return tt.ktt(271);}
"retain" {return tt.ktt(272);}
"return" {return tt.ktt(273);}
"reverse" {return tt.ktt(274);}
"replica" {return tt.ktt(275);}
"resource" {return tt.ktt(276);}
"remove" {return tt.ktt(277);}
"reorganize" {return tt.ktt(278);}
"repair" {return tt.ktt(279);}
"reuse" {return tt.ktt(280);}
"revoke" {return tt.ktt(281);}
"right" {return tt.ktt(282);}
"rotate" {return tt.ktt(283);}
"rlike" {return tt.ktt(284);}
"rollback" {return tt.ktt(285);}
"rollup" {return tt.ktt(286);}
"role" {return tt.ktt(287);}
"row" {return tt.ktt(288);}
"rows" {return tt.ktt(289);}
"schedule" {return tt.ktt(290);}
"schema" {return tt.ktt(291);}
"schemas" {return tt.ktt(292);}
"security" {return tt.ktt(293);}
"select" {return tt.ktt(294);}
"sensitive" {return tt.ktt(295);}
"separator" {return tt.ktt(296);}
"server" {return tt.ktt(297);}
"set" {return tt.ktt(298);}
"share" {return tt.ktt(299);}
"shared" {return tt.ktt(300);}
"show" {return tt.ktt(301);}
"signed" {return tt.ktt(302);}
"simple" {return tt.ktt(303);}
"skip" {return tt.ktt(304);}
"slave" {return tt.ktt(305);}
"sounds" {return tt.ktt(306);}
"spatial" {return tt.ktt(307);}
"specific" {return tt.ktt(308);}
"sql" {return tt.ktt(309);}
"sqlexception" {return tt.ktt(310);}
"sqlstate" {return tt.ktt(311);}
"sqlwarning" {return tt.ktt(312);}
"sql_big_result" {return tt.ktt(313);}
"sql_buffer_result" {return tt.ktt(314);}
"sql_cache" {return tt.ktt(315);}
"sql_calc_found_rows" {return tt.ktt(316);}
"sql_no_cache" {return tt.ktt(317);}
"sql_small_result" {return tt.ktt(318);}
"ssl" {return tt.ktt(319);}
"start" {return tt.ktt(320);}
"starting" {return tt.ktt(321);}
"starts" {return tt.ktt(322);}
"storage" {return tt.ktt(323);}
"stored" {return tt.ktt(324);}
"straight_join" {return tt.ktt(325);}
"subject" {return tt.ktt(326);}
"subpartition" {return tt.ktt(327);}
"subpartitions" {return tt.ktt(328);}
"table" {return tt.ktt(329);}
"tablespace" {return tt.ktt(330);}
"temporary" {return tt.ktt(331);}
"temptable" {return tt.ktt(332);}
"terminated" {return tt.ktt(333);}
"than" {return tt.ktt(334);}
"then" {return tt.ktt(335);}
"tls" {return tt.ktt(336);}
"to" {return tt.ktt(337);}
"trailing" {return tt.ktt(338);}
"transaction" {return tt.ktt(339);}
"trigger" {return tt.ktt(340);}
"true" {return tt.ktt(341);}
"truncate" {return tt.ktt(342);}
"undefined" {return tt.ktt(343);}
"undo" {return tt.ktt(344);}
"undofile" {return tt.ktt(345);}
"union" {return tt.ktt(346);}
"unique" {return tt.ktt(347);}
"unknown" {return tt.ktt(348);}
"unlock" {return tt.ktt(349);}
"unbounded" {return tt.ktt(350);}
"unregister" {return tt.ktt(351);}
"unsigned" {return tt.ktt(352);}
"update" {return tt.ktt(353);}
"upgrade" {return tt.ktt(354);}
"usage" {return tt.ktt(355);}
"use" {return tt.ktt(356);}
"using" {return tt.ktt(357);}
"validation" {return tt.ktt(358);}
"value" {return tt.ktt(359);}
"values" {return tt.ktt(360);}
"varcharacter" {return tt.ktt(361);}
"varying" {return tt.ktt(362);}
"view" {return tt.ktt(363);}
"virtual" {return tt.ktt(364);}
"visible" {return tt.ktt(365);}
"wait" {return tt.ktt(366);}
"when" {return tt.ktt(367);}
"where" {return tt.ktt(368);}
"while" {return tt.ktt(369);}
"window" {return tt.ktt(370);}
"with" {return tt.ktt(371);}
"without" {return tt.ktt(372);}
"write" {return tt.ktt(373);}
"x509" {return tt.ktt(374);}
"xor" {return tt.ktt(375);}
"zerofill" {return tt.ktt(376);}
// MARKER_END_KEYWORDS
