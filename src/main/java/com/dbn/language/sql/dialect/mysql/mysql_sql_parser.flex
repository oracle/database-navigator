...
"schema" {return tt.ktt(201);}
"schemas" {return tt.ktt(202);}
"security" {return tt.ktt(203);}
"select" {return tt.ktt(204);}
"sensitive" {return tt.ktt(205);}
"separator" {return tt.ktt(206);}
"set" {return tt.ktt(207);}
"share" {return tt.ktt(208);}
"show" {return tt.ktt(209);}
"simple" {return tt.ktt(210);}
"spatial" {return tt.ktt(211);}
"specific" {return tt.ktt(212);}
"sql" {return tt.ktt(213);}
"sqlexception" {return tt.ktt(214);}
"sqlstate" {return tt.ktt(215);}
"sqlwarning" {return tt.ktt(216);}
"sql_big_result" {return tt.ktt(217);}
"sql_buffer_result" {return tt.ktt(218);}
"sql_cache" {return tt.ktt(219);}
"sql_calc_found_rows" {return tt.ktt(220);}
"sql_no_cache" {return tt.ktt(221);}
"sql_small_result" {return tt.ktt(222);}
"ssl" {return tt.ktt(223);}
"start" {return tt.ktt(224);}
"starting" {return tt.ktt(225);}
"storage" {return tt.ktt(226);}
"stored" {return tt.ktt(227);}
"straight_join" {return tt.ktt(228);}
"subpartition" {return tt.ktt(229);}
"table" {return tt.ktt(230);}
"tablespace" {return tt.ktt(231);}
"temporary" {return tt.ktt(232);}
"temptable" {return tt.ktt(233);}
"terminated" {return tt.ktt(234);}
"than" {return tt.ktt(235);}
"then" {return tt.ktt(236);}
"to" {return tt.ktt(237);}
"trailing" {return tt.ktt(238);}
"transaction" {return tt.ktt(239);}
"trigger" {return tt.ktt(240);}
"true" {return tt.ktt(241);}
"truncate" {return tt.ktt(242);}
"undefined" {return tt.ktt(243);}
"undo" {return tt.ktt(244);}
"union" {return tt.ktt(245);}
"unique" {return tt.ktt(246);}
"unlock" {return tt.ktt(247);}
"unsigned" {return tt.ktt(248);}
"update" {return tt.ktt(249);}
"usage" {return tt.ktt(250);}
"use" {return tt.ktt(251);}
"using" {return tt.ktt(252);}
"value" {return tt.ktt(253);}
"values" {return tt.ktt(254);}
"varcharacter" {return tt.ktt(255);}
"varying" {return tt.ktt(256);}
"view" {return tt.ktt(257);}
"virtual" {return tt.ktt(258);}
"visible" {return tt.ktt(259);}
"when" {return tt.ktt(260);}
"where" {return tt.ktt(261);}
"while" {return tt.ktt(262);}
"with" {return tt.ktt(263);}
"write" {return tt.ktt(264);}
"xor" {return tt.ktt(265);}
"zerofill" {return tt.ktt(266);}
// MARKER_END_KEYWORDS
