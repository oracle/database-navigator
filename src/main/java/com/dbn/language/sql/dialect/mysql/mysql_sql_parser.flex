...
"at" {return tt.ktt(14);}
"attribute" {return tt.ktt(15);}
"authentication" {return tt.ktt(16);}
"before" {return tt.ktt(17);}
"begin" {return tt.ktt(18);}
"between" {return tt.ktt(19);}
"both" {return tt.ktt(20);}
"btree" {return tt.ktt(21);}
"by" {return tt.ktt(22);}
"call" {return tt.ktt(23);}
"cascade" {return tt.ktt(24);}
"cascaded" {return tt.ktt(25);}
"cast" {return tt.ktt(26);}
"case" {return tt.ktt(27);}
"change" {return tt.ktt(28);}
"character" {return tt.ktt(29);}
"charset" {return tt.ktt(30);}
"check" {return tt.ktt(31);}
"checksum" {return tt.ktt(32);}
"cipher" {return tt.ktt(33);}
"close" {return tt.ktt(34);}
"collate" {return tt.ktt(35);}
"column" {return tt.ktt(36);}
"columns" {return tt.ktt(37);}
"comment" {return tt.ktt(38);}
"compact" {return tt.ktt(39);}
"completion" {return tt.ktt(40);}
"compressed" {return tt.ktt(41);}
"compression" {return tt.ktt(42);}
"concurrent" {return tt.ktt(43);}
"condition" {return tt.ktt(44);}
"connection" {return tt.ktt(45);}
"constraint" {return tt.ktt(46);}
"continue" {return tt.ktt(47);}
"convert" {return tt.ktt(48);}
"copy" {return tt.ktt(49);}
"create" {return tt.ktt(50);}
"cross" {return tt.ktt(51);}
"current" {return tt.ktt(52);}
"current_user" {return tt.ktt(53);}
"cursor" {return tt.ktt(54);}
"data" {return tt.ktt(55);}
"database" {return tt.ktt(56);}
"databases" {return tt.ktt(57);}
"declare" {return tt.ktt(58);}
"default" {return tt.ktt(59);}
"definer" {return tt.ktt(60);}
"delayed" {return tt.ktt(61);}
"delete" {return tt.ktt(62);}
"desc" {return tt.ktt(63);}
"describe" {return tt.ktt(64);}
"deterministic" {return tt.ktt(65);}
"directory" {return tt.ktt(66);}
"disable" {return tt.ktt(67);}
"disk" {return tt.ktt(68);}
"distinct" {return tt.ktt(69);}
"distinctrow" {return tt.ktt(70);}
"div" {return tt.ktt(71);}
"do" {return tt.ktt(72);}
"drop" {return tt.ktt(73);}
"dual" {return tt.ktt(74);}
"dumpfile" {return tt.ktt(75);}
"duplicate" {return tt.ktt(76);}
"dynamic" {return tt.ktt(77);}
"each" {return tt.ktt(78);}
"else" {return tt.ktt(79);}
"elseif" {return tt.ktt(80);}
"enclosed" {return tt.ktt(81);}
"encryption" {return tt.ktt(82);}
"end" {return tt.ktt(83);}
"enable" {return tt.ktt(84);}
"enforced" {return tt.ktt(85);}
"engine" {return tt.ktt(86);}
"ends" {return tt.ktt(87);}
"escaped" {return tt.ktt(88);}
"event" {return tt.ktt(89);}
"every" {return tt.ktt(90);}
"exists" {return tt.ktt(91);}
"exit" {return tt.ktt(92);}
"exclusive" {return tt.ktt(93);}
"expire" {return tt.ktt(94);}
"expansion" {return tt.ktt(95);}
"explain" {return tt.ktt(96);}
"false" {return tt.ktt(97);}
"fetch" {return tt.ktt(98);}
"fields" {return tt.ktt(99);}
"first" {return tt.ktt(100);}
"fixed" {return tt.ktt(101);}
"float4" {return tt.ktt(102);}
"float8" {return tt.ktt(103);}
"following" {return tt.ktt(104);}
"follows" {return tt.ktt(105);}
"for" {return tt.ktt(106);}
"force" {return tt.ktt(107);}
"foreign" {return tt.ktt(108);}
"from" {return tt.ktt(109);}
"full" {return tt.ktt(110);}
"fulltext" {return tt.ktt(111);}
"generated" {return tt.ktt(112);}
"grant" {return tt.ktt(113);}
"group" {return tt.ktt(114);}
"handler" {return tt.ktt(115);}
"hash" {return tt.ktt(116);}
"having" {return tt.ktt(117);}
"high_priority" {return tt.ktt(118);}
"history" {return tt.ktt(119);}
"if" {return tt.ktt(120);}
"ignore" {return tt.ktt(121);}
"identified" {return tt.ktt(122);}
"in" {return tt.ktt(123);}
"index" {return tt.ktt(124);}
"infile" {return tt.ktt(125);}
"initial" {return tt.ktt(126);}
"inner" {return tt.ktt(127);}
"inplace" {return tt.ktt(128);}
"inout" {return tt.ktt(129);}
"insensitive" {return tt.ktt(130);}
"insert" {return tt.ktt(131);}
"int1" {return tt.ktt(132);}
"int2" {return tt.ktt(133);}
"int3" {return tt.ktt(134);}
"int4" {return tt.ktt(135);}
"int8" {return tt.ktt(136);}
"interval" {return tt.ktt(137);}
"into" {return tt.ktt(138);}
"invisible" {return tt.ktt(139);}
"invoker" {return tt.ktt(140);}
"is" {return tt.ktt(141);}
"issuer" {return tt.ktt(142);}
"iterate" {return tt.ktt(143);}
"join" {return tt.ktt(144);}
"key" {return tt.ktt(145);}
"keys" {return tt.ktt(146);}
"kill" {return tt.ktt(147);}
"language" {return tt.ktt(148);}
"last" {return tt.ktt(149);}
"leading" {return tt.ktt(150);}
"leave" {return tt.ktt(151);}
"left" {return tt.ktt(152);}
"less" {return tt.ktt(153);}
"level" {return tt.ktt(154);}
"like" {return tt.ktt(155);}
"limit" {return tt.ktt(156);}
"linear" {return tt.ktt(157);}
"lines" {return tt.ktt(158);}
"list" {return tt.ktt(159);}
"load" {return tt.ktt(160);}
"local" {return tt.ktt(161);}
"lock" {return tt.ktt(162);}
"long" {return tt.ktt(163);}
"loop" {return tt.ktt(164);}
"match" {return tt.ktt(165);}
"maxvalue" {return tt.ktt(166);}
"memory" {return tt.ktt(167);}
"merge" {return tt.ktt(168);}
"microsecond" {return tt.ktt(169);}
"middleint" {return tt.ktt(170);}
"mod" {return tt.ktt(171);}
"mode" {return tt.ktt(172);}
"modifies" {return tt.ktt(173);}
"national" {return tt.ktt(174);}
"natural" {return tt.ktt(175);}
"never" {return tt.ktt(176);}
"new" {return tt.ktt(177);}
"next" {return tt.ktt(178);}
"no" {return tt.ktt(179);}
"none" {return tt.ktt(180);}
"not" {return tt.ktt(181);}
"null" {return tt.ktt(182);}
"offset" {return tt.ktt(183);}
"oj" {return tt.ktt(184);}
"old" {return tt.ktt(185);}
"on" {return tt.ktt(186);}
"open" {return tt.ktt(187);}
"optimize" {return tt.ktt(188);}
"option" {return tt.ktt(189);}
"optional" {return tt.ktt(190);}
"optionally" {return tt.ktt(191);}
"or" {return tt.ktt(192);}
"order" {return tt.ktt(193);}
"out" {return tt.ktt(194);}
"outer" {return tt.ktt(195);}
"outfile" {return tt.ktt(196);}
"over" {return tt.ktt(197);}
"parser" {return tt.ktt(198);}
"partial" {return tt.ktt(199);}
"partition" {return tt.ktt(200);}
"partitions" {return tt.ktt(201);}
"password" {return tt.ktt(202);}
"precision" {return tt.ktt(203);}
"preceding" {return tt.ktt(204);}
"precedes" {return tt.ktt(205);}
"preserve" {return tt.ktt(206);}
"prev" {return tt.ktt(207);}
"primary" {return tt.ktt(208);}
"procedure" {return tt.ktt(209);}
"purge" {return tt.ktt(210);}
"query" {return tt.ktt(211);}
"quick" {return tt.ktt(212);}
"random" {return tt.ktt(213);}
"range" {return tt.ktt(214);}
"read" {return tt.ktt(215);}
"reads" {return tt.ktt(216);}
"read_only" {return tt.ktt(217);}
"read_write" {return tt.ktt(218);}
"recursive" {return tt.ktt(219);}
"redundant" {return tt.ktt(220);}
"references" {return tt.ktt(221);}
"regexp" {return tt.ktt(222);}
"release" {return tt.ktt(223);}
"rename" {return tt.ktt(224);}
"repeat" {return tt.ktt(225);}
"replace" {return tt.ktt(226);}
"require" {return tt.ktt(227);}
"restrict" {return tt.ktt(228);}
"return" {return tt.ktt(229);}
"reverse" {return tt.ktt(230);}
"replica" {return tt.ktt(231);}
"reuse" {return tt.ktt(232);}
"revoke" {return tt.ktt(233);}
"right" {return tt.ktt(234);}
"rlike" {return tt.ktt(235);}
"rollback" {return tt.ktt(236);}
"rollup" {return tt.ktt(237);}
"role" {return tt.ktt(238);}
"row" {return tt.ktt(239);}
"rows" {return tt.ktt(240);}
"schedule" {return tt.ktt(241);}
"schema" {return tt.ktt(242);}
"schemas" {return tt.ktt(243);}
"security" {return tt.ktt(244);}
"select" {return tt.ktt(245);}
"sensitive" {return tt.ktt(246);}
"separator" {return tt.ktt(247);}
"set" {return tt.ktt(248);}
"share" {return tt.ktt(249);}
"shared" {return tt.ktt(250);}
"show" {return tt.ktt(251);}
"simple" {return tt.ktt(252);}
"slave" {return tt.ktt(253);}
"spatial" {return tt.ktt(254);}
"specific" {return tt.ktt(255);}
"sql" {return tt.ktt(256);}
"sqlexception" {return tt.ktt(257);}
"sqlstate" {return tt.ktt(258);}
"sqlwarning" {return tt.ktt(259);}
"sql_big_result" {return tt.ktt(260);}
"sql_buffer_result" {return tt.ktt(261);}
"sql_cache" {return tt.ktt(262);}
"sql_calc_found_rows" {return tt.ktt(263);}
"sql_no_cache" {return tt.ktt(264);}
"sql_small_result" {return tt.ktt(265);}
"ssl" {return tt.ktt(266);}
"start" {return tt.ktt(267);}
"starting" {return tt.ktt(268);}
"starts" {return tt.ktt(269);}
"storage" {return tt.ktt(270);}
"stored" {return tt.ktt(271);}
"straight_join" {return tt.ktt(272);}
"subject" {return tt.ktt(273);}
"subpartition" {return tt.ktt(274);}
"subpartitions" {return tt.ktt(275);}
"table" {return tt.ktt(276);}
"tablespace" {return tt.ktt(277);}
"temporary" {return tt.ktt(278);}
"temptable" {return tt.ktt(279);}
"terminated" {return tt.ktt(280);}
"than" {return tt.ktt(281);}
"then" {return tt.ktt(282);}
"to" {return tt.ktt(283);}
"trailing" {return tt.ktt(284);}
"transaction" {return tt.ktt(285);}
"trigger" {return tt.ktt(286);}
"true" {return tt.ktt(287);}
"truncate" {return tt.ktt(288);}
"undefined" {return tt.ktt(289);}
"undo" {return tt.ktt(290);}
"union" {return tt.ktt(291);}
"unique" {return tt.ktt(292);}
"unlock" {return tt.ktt(293);}
"unbounded" {return tt.ktt(294);}
"unsigned" {return tt.ktt(295);}
"update" {return tt.ktt(296);}
"usage" {return tt.ktt(297);}
"use" {return tt.ktt(298);}
"using" {return tt.ktt(299);}
"value" {return tt.ktt(300);}
"values" {return tt.ktt(301);}
"varcharacter" {return tt.ktt(302);}
"varying" {return tt.ktt(303);}
"view" {return tt.ktt(304);}
"virtual" {return tt.ktt(305);}
"visible" {return tt.ktt(306);}
"when" {return tt.ktt(307);}
"where" {return tt.ktt(308);}
"while" {return tt.ktt(309);}
"with" {return tt.ktt(310);}
"write" {return tt.ktt(311);}
"x509" {return tt.ktt(312);}
"xor" {return tt.ktt(313);}
"zerofill" {return tt.ktt(314);}
// MARKER_END_KEYWORDS
