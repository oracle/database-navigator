...
"join" {return tt.ktt(166);}
"key" {return tt.ktt(167);}
"keyring" {return tt.ktt(168);}
"keys" {return tt.ktt(169);}
"kill" {return tt.ktt(170);}
"language" {return tt.ktt(171);}
"last" {return tt.ktt(172);}
"leading" {return tt.ktt(173);}
"leave" {return tt.ktt(174);}
"left" {return tt.ktt(175);}
"less" {return tt.ktt(176);}
"level" {return tt.ktt(177);}
"library" {return tt.ktt(178);}
"like" {return tt.ktt(179);}
"limit" {return tt.ktt(180);}
"linear" {return tt.ktt(181);}
"lines" {return tt.ktt(182);}
"list" {return tt.ktt(183);}
"load" {return tt.ktt(184);}
"local" {return tt.ktt(185);}
"logfile" {return tt.ktt(186);}
"locked" {return tt.ktt(187);}
"lock" {return tt.ktt(188);}
"long" {return tt.ktt(189);}
"loop" {return tt.ktt(190);}
"master" {return tt.ktt(191);}
"match" {return tt.ktt(192);}
"maxvalue" {return tt.ktt(193);}
"member" {return tt.ktt(194);}
"memory" {return tt.ktt(195);}
"merge" {return tt.ktt(196);}
"microsecond" {return tt.ktt(197);}
"middleint" {return tt.ktt(198);}
"mod" {return tt.ktt(199);}
"mode" {return tt.ktt(200);}
"modify" {return tt.ktt(201);}
"modifies" {return tt.ktt(202);}
"national" {return tt.ktt(203);}
"natural" {return tt.ktt(204);}
"never" {return tt.ktt(205);}
"new" {return tt.ktt(206);}
"next" {return tt.ktt(207);}
"no" {return tt.ktt(208);}
"none" {return tt.ktt(209);}
"not" {return tt.ktt(210);}
"nowait" {return tt.ktt(211);}
"null" {return tt.ktt(212);}
"offset" {return tt.ktt(213);}
"of" {return tt.ktt(214);}
"oj" {return tt.ktt(215);}
"old" {return tt.ktt(216);}
"on" {return tt.ktt(217);}
"open" {return tt.ktt(218);}
"optimize" {return tt.ktt(219);}
"option" {return tt.ktt(220);}
"options" {return tt.ktt(221);}
"optional" {return tt.ktt(222);}
"optionally" {return tt.ktt(223);}
"only" {return tt.ktt(224);}
"or" {return tt.ktt(225);}
"order" {return tt.ktt(226);}
"out" {return tt.ktt(227);}
"outer" {return tt.ktt(228);}
"outfile" {return tt.ktt(229);}
"off" {return tt.ktt(230);}
"owner" {return tt.ktt(231);}
"over" {return tt.ktt(232);}
"parser" {return tt.ktt(233);}
"partial" {return tt.ktt(234);}
"partition" {return tt.ktt(235);}
"partitioning" {return tt.ktt(236);}
"partitions" {return tt.ktt(237);}
"password" {return tt.ktt(238);}
"precision" {return tt.ktt(239);}
"preceding" {return tt.ktt(240);}
"precedes" {return tt.ktt(241);}
"preserve" {return tt.ktt(242);}
"prev" {return tt.ktt(243);}
"primary" {return tt.ktt(244);}
"procedure" {return tt.ktt(245);}
"purge" {return tt.ktt(246);}
"query" {return tt.ktt(247);}
"quick" {return tt.ktt(248);}
"random" {return tt.ktt(249);}
"range" {return tt.ktt(250);}
"read" {return tt.ktt(251);}
"reads" {return tt.ktt(252);}
"read_only" {return tt.ktt(253);}
"read_write" {return tt.ktt(254);}
"rebuild" {return tt.ktt(255);}
"recursive" {return tt.ktt(256);}
"redundant" {return tt.ktt(257);}
"redo_log" {return tt.ktt(258);}
"references" {return tt.ktt(259);}
"regexp" {return tt.ktt(260);}
"release" {return tt.ktt(261);}
"reload" {return tt.ktt(262);}
"rename" {return tt.ktt(263);}
"repeat" {return tt.ktt(264);}
"replace" {return tt.ktt(265);}
"registration" {return tt.ktt(266);}
"require" {return tt.ktt(267);}
"restrict" {return tt.ktt(268);}
"retain" {return tt.ktt(269);}
"return" {return tt.ktt(270);}
"reverse" {return tt.ktt(271);}
"replica" {return tt.ktt(272);}
"resource" {return tt.ktt(273);}
"remove" {return tt.ktt(274);}
"reorganize" {return tt.ktt(275);}
"repair" {return tt.ktt(276);}
"reuse" {return tt.ktt(277);}
"revoke" {return tt.ktt(278);}
"right" {return tt.ktt(279);}
"rotate" {return tt.ktt(280);}
"rlike" {return tt.ktt(281);}
"rollback" {return tt.ktt(282);}
"rollup" {return tt.ktt(283);}
"role" {return tt.ktt(284);}
"row" {return tt.ktt(285);}
"rows" {return tt.ktt(286);}
"schedule" {return tt.ktt(287);}
"schema" {return tt.ktt(288);}
"schemas" {return tt.ktt(289);}
"security" {return tt.ktt(290);}
"select" {return tt.ktt(291);}
"sensitive" {return tt.ktt(292);}
"separator" {return tt.ktt(293);}
"server" {return tt.ktt(294);}
"set" {return tt.ktt(295);}
"share" {return tt.ktt(296);}
"shared" {return tt.ktt(297);}
"show" {return tt.ktt(298);}
"signed" {return tt.ktt(299);}
"simple" {return tt.ktt(300);}
"skip" {return tt.ktt(301);}
"slave" {return tt.ktt(302);}
"spatial" {return tt.ktt(303);}
"specific" {return tt.ktt(304);}
"sql" {return tt.ktt(305);}
"sqlexception" {return tt.ktt(306);}
"sqlstate" {return tt.ktt(307);}
"sqlwarning" {return tt.ktt(308);}
"sql_big_result" {return tt.ktt(309);}
"sql_buffer_result" {return tt.ktt(310);}
"sql_cache" {return tt.ktt(311);}
"sql_calc_found_rows" {return tt.ktt(312);}
"sql_no_cache" {return tt.ktt(313);}
"sql_small_result" {return tt.ktt(314);}
"ssl" {return tt.ktt(315);}
"start" {return tt.ktt(316);}
"starting" {return tt.ktt(317);}
"starts" {return tt.ktt(318);}
"storage" {return tt.ktt(319);}
"stored" {return tt.ktt(320);}
"straight_join" {return tt.ktt(321);}
"subject" {return tt.ktt(322);}
"subpartition" {return tt.ktt(323);}
"subpartitions" {return tt.ktt(324);}
"table" {return tt.ktt(325);}
"tablespace" {return tt.ktt(326);}
"temporary" {return tt.ktt(327);}
"temptable" {return tt.ktt(328);}
"terminated" {return tt.ktt(329);}
"than" {return tt.ktt(330);}
"then" {return tt.ktt(331);}
"tls" {return tt.ktt(332);}
"to" {return tt.ktt(333);}
"trailing" {return tt.ktt(334);}
"transaction" {return tt.ktt(335);}
"trigger" {return tt.ktt(336);}
"true" {return tt.ktt(337);}
"truncate" {return tt.ktt(338);}
"undefined" {return tt.ktt(339);}
"undo" {return tt.ktt(340);}
"undofile" {return tt.ktt(341);}
"union" {return tt.ktt(342);}
"unique" {return tt.ktt(343);}
"unlock" {return tt.ktt(344);}
"unbounded" {return tt.ktt(345);}
"unregister" {return tt.ktt(346);}
"unsigned" {return tt.ktt(347);}
"update" {return tt.ktt(348);}
"upgrade" {return tt.ktt(349);}
"usage" {return tt.ktt(350);}
"use" {return tt.ktt(351);}
"using" {return tt.ktt(352);}
"validation" {return tt.ktt(353);}
"value" {return tt.ktt(354);}
"values" {return tt.ktt(355);}
"varcharacter" {return tt.ktt(356);}
"varying" {return tt.ktt(357);}
"view" {return tt.ktt(358);}
"virtual" {return tt.ktt(359);}
"visible" {return tt.ktt(360);}
"wait" {return tt.ktt(361);}
"when" {return tt.ktt(362);}
"where" {return tt.ktt(363);}
"while" {return tt.ktt(364);}
"window" {return tt.ktt(365);}
"with" {return tt.ktt(366);}
"without" {return tt.ktt(367);}
"write" {return tt.ktt(368);}
"x509" {return tt.ktt(369);}
"xor" {return tt.ktt(370);}
"zerofill" {return tt.ktt(371);}
// MARKER_END_KEYWORDS
