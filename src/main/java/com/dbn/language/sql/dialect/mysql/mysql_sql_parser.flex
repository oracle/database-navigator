...
"fetch" {return tt.ktt(79);}
"fields" {return tt.ktt(80);}
"first" {return tt.ktt(81);}
"fixed" {return tt.ktt(82);}
...
"generated" {return tt.ktt(91);}
"grant" {return tt.ktt(92);}
"group" {return tt.ktt(93);}
"handler" {return tt.ktt(94);}
"hash" {return tt.ktt(95);}
"having" {return tt.ktt(96);}
"high_priority" {return tt.ktt(97);}
"if" {return tt.ktt(98);}
"ignore" {return tt.ktt(99);}
"in" {return tt.ktt(100);}
"index" {return tt.ktt(101);}
"infile" {return tt.ktt(102);}
"inner" {return tt.ktt(103);}
"inout" {return tt.ktt(104);}
"insensitive" {return tt.ktt(105);}
"insert" {return tt.ktt(106);}
"int1" {return tt.ktt(107);}
"int2" {return tt.ktt(108);}
"int3" {return tt.ktt(109);}
"int4" {return tt.ktt(110);}
"int8" {return tt.ktt(111);}
"interval" {return tt.ktt(112);}
"into" {return tt.ktt(113);}
"invisible" {return tt.ktt(114);}
"invoker" {return tt.ktt(115);}
"is" {return tt.ktt(116);}
"iterate" {return tt.ktt(117);}
"join" {return tt.ktt(118);}
"key" {return tt.ktt(119);}
"keys" {return tt.ktt(120);}
"kill" {return tt.ktt(121);}
"language" {return tt.ktt(122);}
"last" {return tt.ktt(123);}
"leading" {return tt.ktt(124);}
"leave" {return tt.ktt(125);}
"left" {return tt.ktt(126);}
"less" {return tt.ktt(127);}
"level" {return tt.ktt(128);}
"like" {return tt.ktt(129);}
"limit" {return tt.ktt(130);}
"linear" {return tt.ktt(131);}
"lines" {return tt.ktt(132);}
"list" {return tt.ktt(133);}
"load" {return tt.ktt(134);}
"local" {return tt.ktt(135);}
"lock" {return tt.ktt(136);}
"long" {return tt.ktt(137);}
"loop" {return tt.ktt(138);}
"match" {return tt.ktt(139);}
"maxvalue" {return tt.ktt(140);}
"memory" {return tt.ktt(141);}
"merge" {return tt.ktt(142);}
"microsecond" {return tt.ktt(143);}
"middleint" {return tt.ktt(144);}
"mod" {return tt.ktt(145);}
"mode" {return tt.ktt(146);}
"modifies" {return tt.ktt(147);}
"national" {return tt.ktt(148);}
"natural" {return tt.ktt(149);}
"next" {return tt.ktt(150);}
"no" {return tt.ktt(151);}
"not" {return tt.ktt(152);}
"null" {return tt.ktt(153);}
"offset" {return tt.ktt(154);}
"oj" {return tt.ktt(155);}
"on" {return tt.ktt(156);}
"open" {return tt.ktt(157);}
"optimize" {return tt.ktt(158);}
"option" {return tt.ktt(159);}
"optionally" {return tt.ktt(160);}
"or" {return tt.ktt(161);}
"order" {return tt.ktt(162);}
"out" {return tt.ktt(163);}
"outer" {return tt.ktt(164);}
"outfile" {return tt.ktt(165);}
"parser" {return tt.ktt(166);}
"partial" {return tt.ktt(167);}
"partition" {return tt.ktt(168);}
"partitions" {return tt.ktt(169);}
"password" {return tt.ktt(170);}
"precision" {return tt.ktt(171);}
"prev" {return tt.ktt(172);}
"primary" {return tt.ktt(173);}
"procedure" {return tt.ktt(174);}
"purge" {return tt.ktt(175);}
"query" {return tt.ktt(176);}
"quick" {return tt.ktt(177);}
"range" {return tt.ktt(178);}
"read" {return tt.ktt(179);}
"read_only" {return tt.ktt(180);}
"read_write" {return tt.ktt(181);}
"reads" {return tt.ktt(182);}
"redundant" {return tt.ktt(183);}
"references" {return tt.ktt(184);}
"regexp" {return tt.ktt(185);}
"release" {return tt.ktt(186);}
"rename" {return tt.ktt(187);}
"repeat" {return tt.ktt(188);}
"replace" {return tt.ktt(189);}
"require" {return tt.ktt(190);}
"restrict" {return tt.ktt(191);}
"return" {return tt.ktt(192);}
"reverse" {return tt.ktt(193);}
"revoke" {return tt.ktt(194);}
"right" {return tt.ktt(195);}
"rlike" {return tt.ktt(196);}
"rollback" {return tt.ktt(197);}
"rollup" {return tt.ktt(198);}
"schema" {return tt.ktt(199);}
"schemas" {return tt.ktt(200);}
"security" {return tt.ktt(201);}
"select" {return tt.ktt(202);}
"sensitive" {return tt.ktt(203);}
"separator" {return tt.ktt(204);}
"set" {return tt.ktt(205);}
"share" {return tt.ktt(206);}
"show" {return tt.ktt(207);}
"simple" {return tt.ktt(208);}
"spatial" {return tt.ktt(209);}
"specific" {return tt.ktt(210);}
"sql" {return tt.ktt(211);}
"sql_big_result" {return tt.ktt(212);}
"sql_buffer_result" {return tt.ktt(213);}
"sql_cache" {return tt.ktt(214);}
"sql_calc_found_rows" {return tt.ktt(215);}
"sql_no_cache" {return tt.ktt(216);}
"sql_small_result" {return tt.ktt(217);}
"sqlexception" {return tt.ktt(218);}
"sqlstate" {return tt.ktt(219);}
"sqlwarning" {return tt.ktt(220);}
"ssl" {return tt.ktt(221);}
"start" {return tt.ktt(222);}
"starting" {return tt.ktt(223);}
"storage" {return tt.ktt(224);}
"stored" {return tt.ktt(225);}
"straight_join" {return tt.ktt(226);}
"subpartition" {return tt.ktt(227);}
"table" {return tt.ktt(228);}
"tablespace" {return tt.ktt(229);}
"temporary" {return tt.ktt(230);}
"temptable" {return tt.ktt(231);}
"terminated" {return tt.ktt(232);}
"than" {return tt.ktt(233);}
"then" {return tt.ktt(234);}
"to" {return tt.ktt(235);}
"trailing" {return tt.ktt(236);}
"transaction" {return tt.ktt(237);}
"trigger" {return tt.ktt(238);}
"truncate" {return tt.ktt(239);}
"undefined" {return tt.ktt(240);}
"undo" {return tt.ktt(241);}
"union" {return tt.ktt(242);}
"unique" {return tt.ktt(243);}
"unlock" {return tt.ktt(244);}
"unsigned" {return tt.ktt(245);}
"update" {return tt.ktt(246);}
"usage" {return tt.ktt(247);}
"use" {return tt.ktt(248);}
"using" {return tt.ktt(249);}
"value" {return tt.ktt(250);}
"values" {return tt.ktt(251);}
"varcharacter" {return tt.ktt(252);}
"varying" {return tt.ktt(253);}
"view" {return tt.ktt(254);}
"virtual" {return tt.ktt(255);}
"visible" {return tt.ktt(256);}
"when" {return tt.ktt(257);}
"where" {return tt.ktt(258);}
"while" {return tt.ktt(259);}
"with" {return tt.ktt(260);}
"write" {return tt.ktt(261);}
"xor" {return tt.ktt(262);}
"zerofill" {return tt.ktt(263);}
"false" {return tt.ktt(264);}
"true" {return tt.ktt(265);}
// MARKER_END_KEYWORDS
...
"char_length" {return tt.ftt(20);}
"character_length" {return tt.ftt(21);}
...
"date_add" {return tt.ftt(39);}
"date_format" {return tt.ftt(40);}
"date_sub" {return tt.ftt(41);}
"datediff" {return tt.ftt(42);}
"day" {return tt.ftt(43);}
"day_hour" {return tt.ftt(44);}
"day_microsecond" {return tt.ftt(45);}
"day_minute" {return tt.ftt(46);}
"day_second" {return tt.ftt(47);}
"dayname" {return tt.ftt(48);}
"dayofmonth" {return tt.ftt(49);}
"dayofweek" {return tt.ftt(50);}
"dayofyear" {return tt.ftt(51);}
...
"time_format" {return tt.ftt(165);}
"time_to_sec" {return tt.ftt(166);}
...
"var_pop" {return tt.ftt(184);}
"var_samp" {return tt.ftt(185);}
