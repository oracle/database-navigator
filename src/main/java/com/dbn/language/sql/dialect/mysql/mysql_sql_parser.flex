...
"case" {return tt.ktt(26);}
"change" {return tt.ktt(27);}
"character" {return tt.ktt(28);}
"charset" {return tt.ktt(29);}
"check" {return tt.ktt(30);}
"checksum" {return tt.ktt(31);}
"cipher" {return tt.ktt(32);}
"close" {return tt.ktt(33);}
"collate" {return tt.ktt(34);}
"column" {return tt.ktt(35);}
"columns" {return tt.ktt(36);}
"comment" {return tt.ktt(37);}
"compact" {return tt.ktt(38);}
"completion" {return tt.ktt(39);}
"compressed" {return tt.ktt(40);}
"compression" {return tt.ktt(41);}
"concurrent" {return tt.ktt(42);}
"condition" {return tt.ktt(43);}
"connection" {return tt.ktt(44);}
"constraint" {return tt.ktt(45);}
"continue" {return tt.ktt(46);}
"convert" {return tt.ktt(47);}
"copy" {return tt.ktt(48);}
"create" {return tt.ktt(49);}
"cross" {return tt.ktt(50);}
"current" {return tt.ktt(51);}
"current_user" {return tt.ktt(52);}
"cursor" {return tt.ktt(53);}
"data" {return tt.ktt(54);}
"database" {return tt.ktt(55);}
"databases" {return tt.ktt(56);}
"declare" {return tt.ktt(57);}
"default" {return tt.ktt(58);}
"definer" {return tt.ktt(59);}
"delayed" {return tt.ktt(60);}
"delete" {return tt.ktt(61);}
"desc" {return tt.ktt(62);}
"describe" {return tt.ktt(63);}
"deterministic" {return tt.ktt(64);}
"directory" {return tt.ktt(65);}
"disable" {return tt.ktt(66);}
"disk" {return tt.ktt(67);}
"distinct" {return tt.ktt(68);}
"distinctrow" {return tt.ktt(69);}
"div" {return tt.ktt(70);}
"do" {return tt.ktt(71);}
"drop" {return tt.ktt(72);}
"dual" {return tt.ktt(73);}
"dumpfile" {return tt.ktt(74);}
"duplicate" {return tt.ktt(75);}
"dynamic" {return tt.ktt(76);}
"each" {return tt.ktt(77);}
"else" {return tt.ktt(78);}
"elseif" {return tt.ktt(79);}
"enclosed" {return tt.ktt(80);}
"encryption" {return tt.ktt(81);}
"end" {return tt.ktt(82);}
"enable" {return tt.ktt(83);}
"enforced" {return tt.ktt(84);}
"engine" {return tt.ktt(85);}
"ends" {return tt.ktt(86);}
"escaped" {return tt.ktt(87);}
"event" {return tt.ktt(88);}
"every" {return tt.ktt(89);}
"exists" {return tt.ktt(90);}
"exit" {return tt.ktt(91);}
"exclusive" {return tt.ktt(92);}
"expire" {return tt.ktt(93);}
"expansion" {return tt.ktt(94);}
"explain" {return tt.ktt(95);}
"false" {return tt.ktt(96);}
"fetch" {return tt.ktt(97);}
"fields" {return tt.ktt(98);}
"first" {return tt.ktt(99);}
"fixed" {return tt.ktt(100);}
"float4" {return tt.ktt(101);}
"float8" {return tt.ktt(102);}
"follows" {return tt.ktt(103);}
"for" {return tt.ktt(104);}
"force" {return tt.ktt(105);}
"foreign" {return tt.ktt(106);}
"from" {return tt.ktt(107);}
"full" {return tt.ktt(108);}
"fulltext" {return tt.ktt(109);}
"generated" {return tt.ktt(110);}
"grant" {return tt.ktt(111);}
"group" {return tt.ktt(112);}
"handler" {return tt.ktt(113);}
"hash" {return tt.ktt(114);}
"having" {return tt.ktt(115);}
"high_priority" {return tt.ktt(116);}
"history" {return tt.ktt(117);}
"if" {return tt.ktt(118);}
"ignore" {return tt.ktt(119);}
"identified" {return tt.ktt(120);}
"in" {return tt.ktt(121);}
"index" {return tt.ktt(122);}
"infile" {return tt.ktt(123);}
"initial" {return tt.ktt(124);}
"inner" {return tt.ktt(125);}
"inplace" {return tt.ktt(126);}
"inout" {return tt.ktt(127);}
"insensitive" {return tt.ktt(128);}
"insert" {return tt.ktt(129);}
"int1" {return tt.ktt(130);}
"int2" {return tt.ktt(131);}
"int3" {return tt.ktt(132);}
"int4" {return tt.ktt(133);}
"int8" {return tt.ktt(134);}
"interval" {return tt.ktt(135);}
"into" {return tt.ktt(136);}
"invisible" {return tt.ktt(137);}
"invoker" {return tt.ktt(138);}
"is" {return tt.ktt(139);}
"issuer" {return tt.ktt(140);}
"iterate" {return tt.ktt(141);}
"join" {return tt.ktt(142);}
"key" {return tt.ktt(143);}
"keys" {return tt.ktt(144);}
"kill" {return tt.ktt(145);}
"language" {return tt.ktt(146);}
"last" {return tt.ktt(147);}
"leading" {return tt.ktt(148);}
"leave" {return tt.ktt(149);}
"left" {return tt.ktt(150);}
"less" {return tt.ktt(151);}
"level" {return tt.ktt(152);}
"like" {return tt.ktt(153);}
"limit" {return tt.ktt(154);}
"linear" {return tt.ktt(155);}
"lines" {return tt.ktt(156);}
"list" {return tt.ktt(157);}
"load" {return tt.ktt(158);}
"local" {return tt.ktt(159);}
"lock" {return tt.ktt(160);}
"long" {return tt.ktt(161);}
"loop" {return tt.ktt(162);}
"match" {return tt.ktt(163);}
"maxvalue" {return tt.ktt(164);}
"memory" {return tt.ktt(165);}
"merge" {return tt.ktt(166);}
"microsecond" {return tt.ktt(167);}
"middleint" {return tt.ktt(168);}
"mod" {return tt.ktt(169);}
"mode" {return tt.ktt(170);}
"modifies" {return tt.ktt(171);}
"national" {return tt.ktt(172);}
"natural" {return tt.ktt(173);}
"never" {return tt.ktt(174);}
"new" {return tt.ktt(175);}
"next" {return tt.ktt(176);}
"no" {return tt.ktt(177);}
"none" {return tt.ktt(178);}
"not" {return tt.ktt(179);}
"null" {return tt.ktt(180);}
"offset" {return tt.ktt(181);}
"oj" {return tt.ktt(182);}
"old" {return tt.ktt(183);}
"on" {return tt.ktt(184);}
"open" {return tt.ktt(185);}
"optimize" {return tt.ktt(186);}
"option" {return tt.ktt(187);}
"optional" {return tt.ktt(188);}
"optionally" {return tt.ktt(189);}
"or" {return tt.ktt(190);}
"order" {return tt.ktt(191);}
"out" {return tt.ktt(192);}
"outer" {return tt.ktt(193);}
"outfile" {return tt.ktt(194);}
"parser" {return tt.ktt(195);}
"partial" {return tt.ktt(196);}
"partition" {return tt.ktt(197);}
"partitions" {return tt.ktt(198);}
"password" {return tt.ktt(199);}
"precision" {return tt.ktt(200);}
"precedes" {return tt.ktt(201);}
"preserve" {return tt.ktt(202);}
"prev" {return tt.ktt(203);}
"primary" {return tt.ktt(204);}
"procedure" {return tt.ktt(205);}
"purge" {return tt.ktt(206);}
"query" {return tt.ktt(207);}
"quick" {return tt.ktt(208);}
"random" {return tt.ktt(209);}
"range" {return tt.ktt(210);}
"read" {return tt.ktt(211);}
"reads" {return tt.ktt(212);}
"read_only" {return tt.ktt(213);}
"read_write" {return tt.ktt(214);}
"recursive" {return tt.ktt(215);}
"redundant" {return tt.ktt(216);}
"references" {return tt.ktt(217);}
"regexp" {return tt.ktt(218);}
"release" {return tt.ktt(219);}
"rename" {return tt.ktt(220);}
"repeat" {return tt.ktt(221);}
"replace" {return tt.ktt(222);}
"require" {return tt.ktt(223);}
"restrict" {return tt.ktt(224);}
"return" {return tt.ktt(225);}
"reverse" {return tt.ktt(226);}
"replica" {return tt.ktt(227);}
"reuse" {return tt.ktt(228);}
"revoke" {return tt.ktt(229);}
"right" {return tt.ktt(230);}
"rlike" {return tt.ktt(231);}
"rollback" {return tt.ktt(232);}
"rollup" {return tt.ktt(233);}
"role" {return tt.ktt(234);}
"row" {return tt.ktt(235);}
"schedule" {return tt.ktt(236);}
"schema" {return tt.ktt(237);}
"schemas" {return tt.ktt(238);}
"security" {return tt.ktt(239);}
"select" {return tt.ktt(240);}
"sensitive" {return tt.ktt(241);}
"separator" {return tt.ktt(242);}
"set" {return tt.ktt(243);}
"share" {return tt.ktt(244);}
"shared" {return tt.ktt(245);}
"show" {return tt.ktt(246);}
"simple" {return tt.ktt(247);}
"slave" {return tt.ktt(248);}
"spatial" {return tt.ktt(249);}
"specific" {return tt.ktt(250);}
"sql" {return tt.ktt(251);}
"sqlexception" {return tt.ktt(252);}
"sqlstate" {return tt.ktt(253);}
"sqlwarning" {return tt.ktt(254);}
"sql_big_result" {return tt.ktt(255);}
"sql_buffer_result" {return tt.ktt(256);}
"sql_cache" {return tt.ktt(257);}
"sql_calc_found_rows" {return tt.ktt(258);}
"sql_no_cache" {return tt.ktt(259);}
"sql_small_result" {return tt.ktt(260);}
"ssl" {return tt.ktt(261);}
"start" {return tt.ktt(262);}
"starting" {return tt.ktt(263);}
"starts" {return tt.ktt(264);}
"storage" {return tt.ktt(265);}
"stored" {return tt.ktt(266);}
"straight_join" {return tt.ktt(267);}
"subject" {return tt.ktt(268);}
"subpartition" {return tt.ktt(269);}
"subpartitions" {return tt.ktt(270);}
"table" {return tt.ktt(271);}
"tablespace" {return tt.ktt(272);}
"temporary" {return tt.ktt(273);}
"temptable" {return tt.ktt(274);}
"terminated" {return tt.ktt(275);}
"than" {return tt.ktt(276);}
"then" {return tt.ktt(277);}
"to" {return tt.ktt(278);}
"trailing" {return tt.ktt(279);}
"transaction" {return tt.ktt(280);}
"trigger" {return tt.ktt(281);}
"true" {return tt.ktt(282);}
"truncate" {return tt.ktt(283);}
"undefined" {return tt.ktt(284);}
"undo" {return tt.ktt(285);}
"union" {return tt.ktt(286);}
"unique" {return tt.ktt(287);}
"unlock" {return tt.ktt(288);}
"unbounded" {return tt.ktt(289);}
"unsigned" {return tt.ktt(290);}
"update" {return tt.ktt(291);}
"usage" {return tt.ktt(292);}
"use" {return tt.ktt(293);}
"using" {return tt.ktt(294);}
"value" {return tt.ktt(295);}
"values" {return tt.ktt(296);}
"varcharacter" {return tt.ktt(297);}
"varying" {return tt.ktt(298);}
"view" {return tt.ktt(299);}
"virtual" {return tt.ktt(300);}
"visible" {return tt.ktt(301);}
"when" {return tt.ktt(302);}
"where" {return tt.ktt(303);}
"while" {return tt.ktt(304);}
"with" {return tt.ktt(305);}
"write" {return tt.ktt(306);}
"x509" {return tt.ktt(307);}
"xor" {return tt.ktt(308);}
"zerofill" {return tt.ktt(309);}
// MARKER_END_KEYWORDS
