...
@Deprecated // replaced by memory optimized DBObjectStatusHolder
public class DBObjectStatusHolderOld {
    private final DBContentType mainContentType;
    private Entry[] statusEntries;

    public DBObjectStatusHolderOld(DBContentType mainContentType) {
