...
public interface DBObjectNavigationList<T extends DBObject> {
    ...
    static <T extends DBObject> DBObjectNavigationList<T> create(@Nls String name, T object) {
        return new DBObjectNavigationListImpl<>(name, object);
    }

    static <T extends DBObject> DBObjectNavigationList<T> create(@Nls String name, List<T> objects) {
        return new DBObjectNavigationListImpl<>(name, objects);
    }

    static <T extends DBObject> DBObjectNavigationList<T> create(@Nls String name, ObjectListProvider<T> objectsProvider) {
