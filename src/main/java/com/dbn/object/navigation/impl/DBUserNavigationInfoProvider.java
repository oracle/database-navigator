...
public class DBUserNavigationInfoProvider extends DBObjectNavigationInfoProviderBase<DBUser> {
    ...
    @Override
    public @Nullable DBObject getDefaultNavigationTarget(DBUser user) {
        return user.getSchema();
    }

    @Override
    public List<DBObjectNavigationList<?>> createNavigationTargets(DBUser user) {
