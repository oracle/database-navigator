...
import static com.dbn.common.util.Chars.toStringAcceptEmpty;
...
public class OciConnectionInputDialog extends DBNDialog<OciConnectionInputForm> implements NotificationSupport {
    ...
    protected void doOKAction() {
        ...
        char[] password = walletDownloadRequired ?
                (form.isSpecifyPassword() ?
                        form.getPassword() :
    ...
    private void downloadNewWallet(String walletLocation, char[] password, Runnable preDownloadRunnable, Runnable showConnectionSettingsRunnable) {
    ...
    private void downloadWallet(File walletLocation, String walletType, char[] password) {
        ...
        try {
            ...
            DownloadWalletCommand command = new DownloadWalletCommand(database, walletLocation, walletType, toStringAcceptEmpty(password));
            command.execute();
