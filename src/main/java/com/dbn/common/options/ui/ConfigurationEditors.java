...
public class ConfigurationEditors {
    public static int validateIntegerValue(@NotNull JTextField inputField, @Nls @NotNull String name, boolean required, int min, int max, @Nls @Nullable String hint) throws ConfigurationException {
        try {
    ...
    public static String validateStringValue(@NotNull JTextField inputField, @Nls @NotNull String name, boolean required) throws ConfigurationException {
        String value = getText(inputField);
