...
public class Icons {
    ...
    public static final Latent<Icon> WINDOW_DATABASE_VECTOR_AI = Latent.basic(()-> init("/img/window/DatabaseAssistant.svg"));
    ...
    public static final Icon VECTOR_TOOLBOX = load("/img/tools/VectorToolkit.svg");
