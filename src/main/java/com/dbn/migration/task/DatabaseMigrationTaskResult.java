...
/**
 * Common execution result base for database migration tasks.
 *
 * <p>This class owns the lifecycle state, change notifications, and DBN database context
 * shared by operation and workflow results. Engine-specific subclasses remain responsible
 * for result forms, icons, cancellation adapters, and structured items such as changesets
 * or versioned migrations.</p>
 */
@Getter
public abstract class DatabaseMigrationTaskResult<
    ...
    protected DatabaseMigrationTaskResult(@NotNull C context) {
