...
/** Table displaying structured object differences reported by Liquibase. */
public class LiquibaseComparisonItemsTable extends DBNTableWithGutter<LiquibaseComparisonItemsTableModel> {
    public LiquibaseComparisonItemsTable(
            @NotNull DBNComponent parent,
            LiquibaseComparisonItemsTableModel model) {
        ...
        Accessibility.setAccessibleName(this, txt("app.liquibase.aria.ComparisonItems"));
    }
