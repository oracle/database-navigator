...
public class ChunkLabForm extends DBNFormBase {
  ...
  public ChunkLabForm(@Nullable Disposable parent, ConnectionHandler connection, EmbeddingChunkingConfig config) {
