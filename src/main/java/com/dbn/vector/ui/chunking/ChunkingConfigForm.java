...
public class ChunkingConfigForm extends VectorToolboxFormBase implements DBNCollapsibleForm {
  ...
  public ChunkingConfigForm(@NotNull VectorToolboxFormBase parent) {
    super(parent);
  ...
  private void openChunkLab() {
    ...
    Dialogs.show(() -> new ChunkLabDialog(getConnection(), chunkConfig),
