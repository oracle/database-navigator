...
/**
 * Configuration for database table data source.
 * Follows VectorToolbox pattern (DBTableSourceConfig).
 */
@Getter
@Setter
public class MLTableSourceConfig implements PersistentStateElement {
