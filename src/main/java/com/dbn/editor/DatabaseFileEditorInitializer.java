...
// TODO implement as DBObjectExtensionPoint
@UtilityClass
public class DatabaseFileEditorInitializer {
    ...
    public static void makeEditorReady(DBObject object) {
        ...
        // add more specific prerequisites here
        //...

        // shared logic: load child objects in background
        DBObjectListContainer childObjects = object.getChildObjects();
        if (childObjects != null) {
            childObjects.loadObjectsInBackground();
        }
    }
}
