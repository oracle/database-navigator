...
public class DatasetEditorState extends SortableDataModelState<DatasetEditorState> implements FileEditorState, PersistentStateElement {
    ...
    public void readState(@NotNull Element element) {
        ...
        if (contentTypesElement != null) {
            for (Element child : contentTypesElement.getChildren()) {
                ...
                setContentType(columnName, contentTypeName);
            }
        }
    }
    ...
    public void writeState(Element element) {
        ...
        if (contentTypes != null && !contentTypes.isEmpty()) {
            for (var entry : contentTypes.entrySet()) {
    ...
    public DatasetEditorState clone() {
        DatasetEditorState clone = cast(super.clone());

        clone.columnSetup = Cloneable.clone(columnSetup);
