...
public class DatasetEditorManager extends ProjectComponentBase implements PersistentState {
    ...
    private static final DataLoadInstructions INITIAL_LOAD_INSTRUCTIONS = new DataLoadInstructions(DataLoadInstruction.USE_CURRENT_FILTER, DataLoadInstruction.PRESERVE_CHANGES, DataLoadInstruction.REBUILD);
    private static final DataLoadInstructions RELOAD_LOAD_INSTRUCTIONS = new DataLoadInstructions(DataLoadInstruction.USE_CURRENT_FILTER, DataLoadInstruction.PRESERVE_CHANGES, DataLoadInstruction.DELIBERATE_ACTION);
