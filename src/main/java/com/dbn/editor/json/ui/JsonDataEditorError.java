...
@Setter
@EqualsAndHashCode
public class JsonDataEditorError {
    ...
    public JsonDataEditorError(ConnectionHandler connection, Exception exception) {
    ...
    public JsonDataEditorError(String message, DBObject messageObject) {
