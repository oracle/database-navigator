...
public class DBDataSourceConfigEntryMetadataImpl extends DBObjectMetadataBase implements DBDataSourceConfigEntryMetadata {

    public DBDataSourceConfigEntryMetadataImpl(ResultSet resultSet) {
        super(resultSet);
    }
