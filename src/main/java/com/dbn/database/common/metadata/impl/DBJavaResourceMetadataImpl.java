...
public class DBJavaResourceMetadataImpl extends DBObjectMetadataBase implements DBJavaResourceMetadata {
	public DBJavaResourceMetadataImpl(ResultSet resultSet) {
		super(resultSet);
	}
