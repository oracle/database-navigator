...
public class ChatExpandAllAction extends AbstractChatBoxAction {

    public ChatExpandAllAction() {
        super(txt("app.assistant.action.AssistantExpandAll"));
    }
