...
package com.dbn.assistant.selectai.editor.action;
...
import com.dbn.assistant.selectai.editor.SelectAiEditorAdapter;
...
import static com.dbn.assistant.selectai.editor.SelectAiEditorUtil.getAssistantState;
import static com.dbn.assistant.selectai.editor.SelectAiEditorUtil.getConnection;
...
public abstract class SelectAiBaseEditorAction extends ProjectAction {
    ...
    protected void actionPerformed(@NotNull AnActionEvent e, @NotNull Project project) {
        ...
        SelectAiEditorAdapter.submitQuery(project, editor, connection.getConnectionId(), prompt.getText(), getAction());
    }
    ...
    private String getActionGroupName(@NotNull AnActionEvent e){
        ...
        return AssistantType.SELECT_AI.getName() + " - ";
    }
