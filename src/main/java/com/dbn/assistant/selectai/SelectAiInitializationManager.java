...
package com.dbn.assistant.selectai;
...
@Slf4j
@State(
        name = SelectAiInitializationManager.COMPONENT_NAME,
        storages = @Storage(DatabaseNavigator.STORAGE_FILE))
public class SelectAiInitializationManager extends ProjectComponentBase implements PersistentState {
    public static final String COMPONENT_NAME = "DBNavigator.Project.SelectAiInitializationManager";

    private SelectAiInitializationManager(Project project) {
    ...
    public static SelectAiInitializationManager getInstance(@NotNull Project project) {
        return projectService(project, SelectAiInitializationManager.class);
    }
    ...
    private static AssistantType resolveAssistantType(ConnectionHandler connection) throws SQLException {
        return DatabaseInterfaceInvoker.load(HIGHEST,
                txt("prc.assistant.title.LoadingMetadata"),
