...
@Slf4j
@State(
        name = SelectAiPrerequisiteManager.COMPONENT_NAME,
        storages = @Storage(DatabaseNavigator.STORAGE_FILE))
public class SelectAiPrerequisiteManager extends ProjectComponentBase implements PersistentState {
    public static final String COMPONENT_NAME = "DBNavigator.Project.SelectAiPrerequisiteManager";

    private SelectAiPrerequisiteManager(Project project) {
        super(project, COMPONENT_NAME);
    }

    public static SelectAiPrerequisiteManager getInstance(@NotNull Project project) {
        return projectService(project, SelectAiPrerequisiteManager.class);
    }
