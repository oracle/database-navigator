 ...
 */
public class SelectAiIntroductionForm extends DBNFormBase implements AssistantIntroductionForm {
    ...
    @SneakyThrows
    public SelectAiIntroductionForm(@NotNull ChatBoxForm parent) {
        super(parent);
        createInitForm();
        createIntroForm();
