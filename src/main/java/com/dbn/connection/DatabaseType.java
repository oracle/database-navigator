...
public enum DatabaseType implements Constant<DatabaseType>, Presentable{
    ORACLE(
            ...
            array(DatabaseUrlPattern.ORACLE_SERVICE, DatabaseUrlPattern.ORACLE_SID, DatabaseUrlPattern.ORACLE_TNS, DatabaseUrlPattern.GENERIC, DatabaseUrlPattern.ORACLE_EZCONNECT)),
