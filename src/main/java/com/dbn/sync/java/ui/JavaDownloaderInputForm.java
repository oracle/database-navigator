...
@Getter
public abstract class JavaDownloaderInputForm<I extends CodeGeneratorInput> extends DBNFormBase {
    private final I input;

    public JavaDownloaderInputForm(JavaDownloaderInputDialog dialog, I input) {
        super(dialog);
        this.input = input;
    }
