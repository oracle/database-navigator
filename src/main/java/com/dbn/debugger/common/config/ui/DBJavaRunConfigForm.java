...
public class DBJavaRunConfigForm extends DBProgramRunConfigForm<DBJavaRunConfig> {
    ...
    private JavaExecutionInputForm inputForm;

    public DBJavaRunConfigForm(DBJavaRunConfig configuration) {
    ...
    public class MethodHistoryOpenAction extends ProjectAction {
        ...
        @Override
        protected void actionPerformed(@NotNull AnActionEvent e, @NotNull Project project) {
            JavaExecutionManager methodExecutionManager = JavaExecutionManager.getInstance(project);
    ...
    public void setExecutionInput(@Nullable JavaExecutionInput executionInput, boolean touchForm) {
    ...
    private void initializeInputForm(@Nullable JavaExecutionInput executionInput, boolean touchForm) {
        checkDisposed();
        ...
        if (executionInput != null) {
            ...
            if (method != null) {
                inputForm = new JavaExecutionInputForm(this, executionInput, getDebuggerType(), false);
    ...
    private void initialiseExecutionInput(@Nullable JavaExecutionInput executionInput, ProgressIndicator progress) {
    ...
    @Override
    public void writeConfiguration(DBJavaRunConfig configuration) throws ConfigurationException {
    ...
    @Override
    public void readConfiguration(DBJavaRunConfig configuration) {
